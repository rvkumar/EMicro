...
import com.microlabs.admin.form.SubSubLinkArchiveForm;
import com.microlabs.hr.dao.HRDao;

public class SubSubLinkArchiveAction extends DispatchAction{
	...
	public ActionForward deleteUploadedVideo(ActionMapping mapping, ActionForm form,
		...
		try{
			SubSubLinkArchiveForm linksForm = (SubSubLinkArchiveForm) form;
			...
			if(videoList.length==0)
			{
				...
				for(int i=0;i<videoList.length;i++)
				{
					...
					String deleteVideos="delete from video_list where link_name='"+linksForm.getLinkName()+"' and sub_link_name='"+linksForm.getSubLinkName()+"' " +
							"and sub_sub_linkname='"+linksForm.getSubSubLinkName()+"' and video_name='"+videoList[i]+"' and year='"+year+"'";
					int a=0;
			...
			int filecount=0;
			String getFilescount="select count(*) from filelist where link_name='"+linksForm.getLinkName()+"' and sub_link_name='"+linksForm.getSubLinkName()+"' " +
			...
			String sql3="select * from filelist where link_name='"+linksForm.getLinkName()+"' and sub_link_name='"+linksForm.getSubLinkName()+"' and year='"+year+"'" +
					"and sub_sub_linkname='"+linksForm.getSubSubLinkName()+"' ";
			ResultSet rs12 = ad.selectQuery(sql3);
			while (rs12.next())
			{
				linksForm = new SubSubLinkArchiveForm();
			...
			int videocount=0;
			String getVideoscount="select count(*) from video_list where link_name='"+linksForm.getLinkName()+"' and sub_link_name='"+linksForm.getSubLinkName()+"'" +
					"and sub_sub_linkname='"+linksForm.getSubSubLinkName()+"' and year='"+year+"'";
     ...
     if(archiveDataCount>=1)
     {
		...
		*/
		...
		while (rs12.next())
		{
			...
			for (int j = 0; j < l; j++) 
			{
				SubSubLinkArchiveForm linksForm1=new SubSubLinkArchiveForm();
			...
			HttpServletRequest request, HttpServletResponse response)
{
	...
	public ActionForward displaySubSublinks(ActionMapping mapping,
		...
		SubSubLinkArchiveForm linksForm = (SubSubLinkArchiveForm) form;// TODO Auto-generated method stub
		String linkName = linksForm.getLinkName();
		...
		try {
			...
			String sql="select * from links where module='"
				+linkName+"'  and sub_linkname='"+linksForm.getSubLinkName()+"' ";
			ResultSet rs = ad.selectQuery("select * from links where module='"
							+linkName+"'  and  sublink_priority is not null and sub_linkname='"+linksForm.getSubLinkName()+"' " );
