...
public class PreviousIncomeForm extends ActionForm{
	private int id;
	...
	private ArrayList salIdList = new ArrayList();
	private ArrayList salLabelList = new ArrayList();
	...
	public ArrayList getSalIdList() {
		return salIdList;
	}
	public void setSalIdList(ArrayList salIdList) {
		this.salIdList = salIdList;
	}
	public ArrayList getSalLabelList() {
		return salLabelList;
	}
	public void setSalLabelList(ArrayList salLabelList) {
		this.salLabelList = salLabelList;
	}
