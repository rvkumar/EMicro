...
public class ITForm extends ActionForm{
	...
	public ITForm(String requesterId,String subject,String name,String assignedTo,
			String category,String dueBy,String status,String createdDate,
			String priority,String createdBy,String completedDate,		
			String department,String plant) {
		super();
	...
	public ITForm(String name, String requesterId, String subject) {
		super();
		this.name = name;
		this.requesterId = requesterId;
		this.subject = subject;
