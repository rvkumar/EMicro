...
<tr><td><b><b><b>Computer Name/Host Name:</b></td><td colspan="4"><html:text  name="approvalsForm" property="adloginname" style="width:50%;"></html:text></td></tr>
...
<td style="align:absmiddle">&nbsp;CD/DVD_ROM <html:checkbox property="cdrom" value="CD/DVD_ROM" name="approvalsForm" ></html:checkbox>&nbsp;&nbsp;&nbsp;
USB <html:checkbox property="usb" value="USB" name="approvalsForm"></html:checkbox>&nbsp;&nbsp;&nbsp;

</td>
<td><b>Access Type:</b></td><td colspan="1">
<html:select property="accesstype" styleClass="content" styleId="filterId"  name="approvalsForm">
