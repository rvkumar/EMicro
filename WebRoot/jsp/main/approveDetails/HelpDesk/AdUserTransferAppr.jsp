...
<td><b>Existing AD Login Name:&nbsp;<font color="red" >*</font></b></td><td ><bean:write name="approvalsForm" property="adloginname"/></td>
...
<tr>
		...
		<bean:write name="approvalsForm" property="fromlocationId"/>
		 	...
		 	<td>
		<bean:write name="approvalsForm" property="tolocationId"/>
			...
			<tr>
		 	...
		 	<td><bean:write name="approvalsForm" property="fromdepartment"/>
				
      			</td>
      			
      			<td><b>To Department:<font color="red" >*</font></b></td>
		 	<td><bean:write name="approvalsForm" property="todepartment"/>
