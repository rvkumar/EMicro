...
<tr><th colspan="3"><big>Other Details</big></tr>
<tr><td>Request date</td><td colspan="3"><bean:write name="approvalsForm" property="requestDate"/></td></tr>
<tr>

<td><b>Required Folder Acces/Path:</b></td>  
<td colspan="3"><html:text  name="approvalsForm" property="requiredfoldername" style="width:85%;"></html:text>
</td></tr>
<tr>
<td><b>Access Type:</b></td><td colspan="4">
...
<html:multibox property="accesstypes" value="Full"> </html:multibox>&nbsp;<b>Allow Full Access(Download,Print)&nbsp;</b></td>
...
<td colspan="3">
<html:text  name="approvalsForm" property="durationofaccess" style="width: 71px;" ></html:text> Days
</td>
</tr>
...
<tr><td><b>UserName:</b></td><td colspan="1"><html:text  name="approvalsForm" property="username" style="width:80%" ></html:text></td>
<td><b>Password:</b></td><td colspan="1"><html:text  name="approvalsForm" property="password"  ></html:text></td></tr>
