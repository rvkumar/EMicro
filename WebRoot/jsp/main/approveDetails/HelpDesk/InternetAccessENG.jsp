...
<tr><td><b>AD Login Name:</b></td><td colspan="4"><html:text  name="approvalsForm" property="adloginname" style="width:50%;"></html:text></td></tr>
<tr>
<tr>
...
<td><b>Internet Group / Category:</b></td><td colspan="1">
<html:select property="internetgrp" styleClass="content" styleId="filterId" >
<html:option value="">--Select--</html:option>
	<html:option value="Default Internet User">Default Internet User</html:option>
    <html:option value="Internet NoAccess">Internet NoAccess</html:option>
    <html:option value="Plant IT Admin">Plant IT Admin</html:option>
    <html:option value="Financial and Banking User">Financial and Banking User</html:option>
    <html:option value="HR User">HR User</html:option>
...
<html:hidden property="reason" name="approvalsForm" />
