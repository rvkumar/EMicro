...
<tr><th colspan="4"><center><big>Email ID Deletion  Request Form</big></center></th></tr>
...
<tr>
<td><b>Email Id To Be Deleted:&nbsp;<font color="red" >*</font></b></td><td colspan="3"><bean:write name="approvalsForm" property="emailidDelete"/></td>
</tr><tr><td><b>Emails To Be Forwarded To ID:</td><td colspan="3"><bean:write name="approvalsForm" property="forward_MailID"/></td></tr>
<tr>

<td><b>Is He HOD:&nbsp;<font color="red" >*</font></b></td><td><bean:write name="approvalsForm" property="isHeHod"/></td>
	
	<td><b>Is This Common ID:&nbsp;<font color="red" >*</font></b></td><td><bean:write name="approvalsForm" property="isthisCommonId"/></td>
	
</tr>


<tr><td>Delete From :&nbsp;<font color="red" >*</font></td><td colspan="4"><bean:write name="approvalsForm" property="deletefrom"/> </td></tr>
<tr><td>Required Deleted Mail Database:&nbsp;<font color="red" >*</font></td><td>
<logic:equal value="true" property="deletedDBYes" name="approvalsForm">Yes</logic:equal>
<logic:equal value="true" property="deletedDBNo" name="approvalsForm">No</logic:equal>
</td>
<td>Path Where To Be Copied<font color="red" >*</font></td><td><bean:write name="approvalsForm" property="mailIDPath"/></td>
</tr>
<tr>

	<td><b>Reason:&nbsp;<font color="red" >*</font></b></td>
<td colspan="3"><bean:write name="approvalsForm" property="reason"/>	</td>
</tr>
