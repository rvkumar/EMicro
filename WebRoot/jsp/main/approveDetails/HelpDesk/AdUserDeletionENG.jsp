...
<td><b>AD Login Name:&nbsp;<font color="red" >*</font></b></td><td ><html:text  name="approvalsForm" property="adloginname"></html:text></td>
...
<td><b>Required Folder Deletion:&nbsp;<font color="red" >*</font></b></td><td colspan="3"><html:text  name="approvalsForm" property="reqdfolderdeletion" style="width:85%;"></html:text></td></tr>


<tr>

<tr><td>Delete From :&nbsp;<font color="red" >*</font></td><td colspan="4"><html:text  name="approvalsForm" property="deletefrom" styleId="popupDatepicker" style="width:20%;" readonly="true"></html:text></td>
