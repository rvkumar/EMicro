...
<tr><th colspan="4"><center><big>Email ID Creation Request Form</big></center></th></tr>
...
<logic:notEmpty name="showothr">
<tr><td><b>First Name:</b></td><td><html:text  name="approvalsForm" property="firstname" style="width:90%;"></html:text></td>
<td><b>Last Name:&nbsp;</b><html:text  name="approvalsForm" property="lastname" style="width:68%;"></html:text></td>
<td><b>Middle Name:&nbsp;</b><html:text  name="approvalsForm" property="middname" style="width:62%;"></html:text></td>
</tr>
</logic:notEmpty>
<tr>
<td><b>Suggested Email Id:</b></td><td colspan="3"><html:text  name="approvalsForm" property="suggestedEmailId" style="width:50%;"></html:text></td>
</tr>
<tr>
<td><b> How many ID's are there in the requested department</td>
<td colspan="3"><html:text  name="approvalsForm" property="totalIDs" style="width:50%;"></html:text></td>
</tr>
<tr>
<td><b>Designation</b></td>
<td> <html:select  property="designation" name="approvalsForm" onchange="console.log($(this).children(':selected').length)" styleClass="testselect1" >
<html:option value="">--Select--</html:option>
<html:options name="approvalsForm"  property="desgList" labelProperty="desgLabelList"/>
</html:select></td>
<td><b>Department</b></td>
<td>
<html:select  property="department" name="approvalsForm" onchange="console.log($(this).children(':selected').length)" styleClass="testselect1" >
<html:option value="">--Select--</html:option>
...
<td><b>Is He HOD:</b></td><td><html:select property="isHeHod" styleClass="content" styleId="filterId" >
...
<tr>
<td><b>Enable Web Access:</b></td><td><html:select property="enablewebAccess" styleClass="content" styleId="filterId" >
...
<td><b>Is This Common ID:</b></td><td><html:select property="isthisCommonId" styleClass="content" styleId="filterId" >
