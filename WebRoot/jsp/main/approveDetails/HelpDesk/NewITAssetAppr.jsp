...
<logic:equal value="true" property="gxpyes" name="approvalsForm">Yes</logic:equal>
<logic:equal value="true" property="gxpno" name="approvalsForm">No</logic:equal>
...
<logic:equal value="Printer" name="approvalsForm" property="assetcategory">
<tr >
<td>Type Of Printer<font color="red">*</font></td>
<td><bean:write name="approvalsForm" property="typeofprinter"/>


</td>

<td>Print Volume Per Month</td>
<td><bean:write name="approvalsForm" property="printvolpermonth"/></td>

</tr>
<tr >
<td>No.Of Users</td>
<td><bean:write name="approvalsForm" property="users"/></td>


<td>Suggested Model No. If Any</td>
<td><bean:write name="approvalsForm" property="suggestmodelno"/></td>
...
<td><bean:write name="approvalsForm" property="apprxvalue"/></td>
...
<logic:equal value="true" property="lanyes" name="approvalsForm">Yes</logic:equal>
<logic:equal value="true" property="lanno" name="approvalsForm">No</logic:equal>
...
<td colspan="3"><bean:write name="approvalsForm" property="anysplreq"/>
	</td>
</tr>
