...
<tr id="printer" style="visibility: visible;">
...
<td><html:text  name="approvalsForm" property="printvolpermonth" ></html:text></td>

</tr>
<tr id="printer1" style="visibility: visible;">
<td>No.Of Users</td>
<td><html:text  name="approvalsForm" property="users" ></html:text></td>


<td>Suggested Model No. If Any</td>
<td><html:text  name="approvalsForm" property="suggestmodelno" style="width:65%;"></html:text></td>
...
<td><html:text  name="approvalsForm" property="apprxvalue" ></html:text></td>
...
<td colspan="3"><html:textarea property="anysplreq" name="approvalsForm" cols="80" rows="3">
