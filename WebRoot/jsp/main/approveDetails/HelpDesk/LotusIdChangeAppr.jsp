...
<tr>
<td><b>From Email Id:</b></td><td colspan="3"><bean:write name="approvalsForm" property="fromemailId"/></td>
	
</tr>
<tr>
<td><b>Newly Joined:&nbsp;<font color="red" >*</font></b></td><td>
<logic:equal value="true" property="newlyJoinedYes" name="approvalsForm">Yes</logic:equal>
<logic:equal value="true" property="newlyJoinedNo" name="approvalsForm">No</logic:equal>
</td>
<td>Joining Date<div id="joiningDateID" style="visibility: hidden;"><font color="red" >*</font></div></td><td><bean:write name="approvalsForm" property="joiningDate"/></td>
</tr>
<tr>
<td><b>Suggested Email Id:&nbsp;<font color="red" >*</font></b></td><td colspan="3"><bean:write name="approvalsForm" property="suggestedEmailId"/></td></tr>
<tr>
<td><b>How many ID's are there in<br/> the requested department<font color="red" >*</font></td>
<td colspan="3"><bean:write name="approvalsForm" property="totalIDs"/></td>
</tr>
<tr><td><b>Is He HOD:&nbsp;<font color="red" >*</font></b></td><td><bean:write name="approvalsForm" property="isHeHod"/></td>
	<td><b>Transfer Old Emails:&nbsp;<font color="red" >*</font></b></td><td><bean:write name="approvalsForm" property="transferoldmail"/></td>
</tr>
<tr>
...
<tr>
<td><b>Is This Common ID:&nbsp;<font color="red" >*</font></b></td><td><bean:write name="approvalsForm" property="isthisCommonId"/>

	

	</td>
<td><b>Enable Web Access:&nbsp;<font color="red" >*</font></b></td><td><bean:write name="approvalsForm" property="enablewebAccess"/>
	</td></tr>
	<tr><td ><b>Reason:</b></td>
