...
if(document.forms[0].assetvalue.value=="")
 ...
 if(document.forms[0].cdrom.checked==false && document.forms[0].usb.checked==false && document.forms[0].floppy.checked==false)
	    {
	    ...
	    if(document.forms[0].cdrom.checked==true && document.forms[0].usb.checked==true )
	    {
	      alert("Please Select Only One Device Type");
	      document.forms[0].cdrom.focus();
	        return false;
	    
	    }
	      if(document.forms[0].cdrom.checked==true && document.forms[0].floppy.checked==true )
	    {
	      alert("Please Select Only One Device Type");
	      document.forms[0].cdrom.focus();
	        return false;
	      ...
	      if(document.forms[0].usb.checked==true && document.forms[0].floppy.checked==true )
	    {
	      alert("Please Select Only One Device Type");
	      document.forms[0].cdrom.focus();
	        return false;
	      ...
	      if(document.forms[0].cdrom.checked==true && document.forms[0].usb.checked==true && document.forms[0].floppy.checked==true )
	    {
	      alert("Please Select Only One Device Type");
	      document.forms[0].cdrom.focus();
	        return false;
...
<tr><td><b><b><b>Computer Name/Host Name:</b></td><td colspan="4"><bean:write name="approvalsForm" property="adloginname"/></td></tr>

<tr>
<td><b>Asset Details:</b></td>
<td colspan="4"><bean:write name="approvalsForm" property="assetvalue"/>

</td>
</tr>
<tr>
<td><b>Device Type:</b></td>
<td style="align:absmiddle">&nbsp;<bean:write name="approvalsForm" property="cdrom"/>&nbsp;&nbsp;&nbsp;
<bean:write name="approvalsForm" property="usb"/>&nbsp;&nbsp;&nbsp;

</td>
<td><b>Access Type:</b></td><td colspan="1"><bean:write name="approvalsForm" property="accesstype"/>
</td></tr>
<tr>
	<td><b>Reason:</b></td>
