...
.text_field {
  ...
  <body>
	...
	<html:hidden name="approvalsForm" property="requestNumber" />
		...
		<logic:notEmpty name="familyTempList">
               <logic:iterate id="abc1" name="familyHistList">	
					 	<%
								JoiningFormalityForm empFormApp = (JoiningFormalityForm) abc1;
								%>
              <logic:iterate id="abc" name="familyTempList">
				<%
				...
				<% if((!(empFormApp.getFamilyDependentTypeID()== null) && !(empForm.getFamilyDependentTypeID().equalsIgnoreCase(""))) || !(empForm.getFamilyDependentTypeID()== null)&& !(empFormApp.getFamilyDependentTypeID()== null)) 
                 {
                 %>
						<tr>
							<td><b>
							...
							<td>
							${abc.familyDependentTypeID}
							</td>
							<td>
							${abc1.familyDependentTypeID}
							</td>
							</tr>
								<%} %>
						<% if((!(empFormApp.getFtitle()== null) && !(empForm.getFtitle().equalsIgnoreCase(""))) || !(empForm.getFtitle()== null)&& !(empFormApp.getFtitle()== null)) 
                 {
                 %>			
							<tr>
						...
						<td>
							...
							<%} %>
							<% if((!(empFormApp.getFfirstName()== null) && !(empForm.getFfirstName().equalsIgnoreCase(""))) || !(empForm.getFfirstName()== null)&& !(empFormApp.getFfirstName()== null)) 
                 {
                 %>	
						<tr>
							<td><b>
							...
							<%} %>
								<% if((!(empFormApp.getFmiddleName()== null) && !(empForm.getFmiddleName().equalsIgnoreCase(""))) || !(empForm.getFmiddleName()== null)&& !(empFormApp.getFmiddleName()== null)) 
                 {
                 %>	
							<tr>
							<td><b>
							...
							<%} %>
								<% if((!(empFormApp.getFlastName()== null) && !(empForm.getFlastName().equalsIgnoreCase(""))) || !(empForm.getFlastName()== null)&& !(empFormApp.getFlastName()== null)) 
                 {
                 %>	
						<tr>
							<td><b>
							...
							<td>${abc1.flastName}</td>
							</tr>
							<%} %>
								<% if((!(empFormApp.getFinitials()== null) && !(empForm.getFinitials().equalsIgnoreCase(""))) || !(empForm.getFinitials()== null)&& !(empFormApp.getFinitials()== null)) 
                 {
                 %>	
							<tr>
							<td><b>
...
<td>${abc1.finitials}</td>
						</tr>
						<%} %>
			<% if((!(empFormApp.getFgender()== null) && !(empForm.getFgender().equalsIgnoreCase(""))) || !(empForm.getFgender()== null)&& !(empFormApp.getFgender()== null)) 
                 {
                 %>	
						<tr>
							<td><b>
							...
							<td>${abc1.fgender}</td>
									...
									<%} %>
			<% if((!(empFormApp.getFdateofBirth()== null) && !(empForm.getFdateofBirth().equalsIgnoreCase(""))) || !(empForm.getFdateofBirth()== null)&& !(empFormApp.getFdateofBirth()== null)) 
                 {
                 %>	
							<tr>
							<td><b>
							...
							<td>
								...
								<td>${abc1.fdateofBirth}</td>
						</tr>
								<%} %>
			<% if((!(empFormApp.getFbirthplace()== null) && !(empForm.getFbirthplace().equalsIgnoreCase(""))) || !(empForm.getFbirthplace()== null)&& !(empFormApp.getFbirthplace()== null)) 
                 {
                 %>
						<tr>
							<td><b>
							...
							<td>	${abc.fbirthplace}
								...
								<td>${abc1.fbirthplace}</td>
						</tr>
							<%} %>
			<% if((!(empFormApp.getFtelephoneNumber()== null) && !(empForm.getFtelephoneNumber().equalsIgnoreCase(""))) || !(empForm.getFtelephoneNumber()== null)&& !(empFormApp.getFtelephoneNumber()== null)) 
                 {
                 %>
							<tr>
							<td><b>
							...
							<td>	${abc.ftelephoneNumber}
							</td>
					<td>${abc1.ftelephoneNumber}</td>
						</tr>
						<%} %>
			<% if((!(empFormApp.getFmobileNumber()== null) && !(empForm.getFmobileNumber().equalsIgnoreCase(""))) || !(empForm.getFmobileNumber()== null)&& !(empFormApp.getFmobileNumber()== null)) 
                 {
                 %>
							<tr>
						<tr>
							...
							<td>	${abc.fmobileNumber}
							</td>
							<td>${abc1.fmobileNumber}</td>
						</tr>
						<%} %>
			<% if((!(empFormApp.getFemailAddress()== null) && !(empForm.getFemailAddress().equalsIgnoreCase(""))) || !(empForm.getFemailAddress()== null)&& !(empFormApp.getFemailAddress()== null)) 
                 {
                 %>
							<tr>
							<td><b>
							...
							<td>	${abc.femailAddress}
							</td>
					<td>${abc1.femailAddress}</td>
						</tr>
						<%} %>
			<% if((!(empFormApp.getFbloodGroup()== null) && !(empForm.getFbloodGroup().equalsIgnoreCase(""))) || !(empForm.getFbloodGroup()== null)&& !(empFormApp.getFbloodGroup()== null)) 
                 {
                 %>
						<tr>
							<td><b>
							...
							<td>${abc1.fbloodGroup}</td>
						</tr>
						<%} %>
			<% if((!(empFormApp.getFdependent()== null) && !(empForm.getFdependent().equalsIgnoreCase(""))) || !(empForm.getFdependent()== null)&& !(empFormApp.getFdependent()== null)) 
                 {
                 %>
							<tr>
							<td><b>
					...
					<td>${abc1.fdependent}</td>
						</tr>
						<%} %>
			<% if((!(empFormApp.getFemployeeofCompany()== null) && !(empForm.getFdependent().equalsIgnoreCase(""))) || !(empForm.getFdependent()== null)&& !(empFormApp.getFdependent()== null)) 
                 {
                 %>
							<tr>
							<td><b>
							...
							<td>	${abc.femployeeofCompany}
								
							</td>
							<td>${abc1.femployeeofCompany}</td>
						</tr>
						<%} %>
			<% if((!(empFormApp.getFemployeeNumber()== null) && !(empForm.getFemployeeNumber().equalsIgnoreCase(""))) || !(empForm.getFemployeeNumber()== null)&& !(empFormApp.getFemployeeNumber()== null)) 
                 {
                 %>
							<tr>
							<td><b>
							...
							<td>	${abc.femployeeNumber}
								
							</td>
							<td>
							${abc1.femployeeNumber}
							</td>
						</tr>
				<%} %>
					</table>
