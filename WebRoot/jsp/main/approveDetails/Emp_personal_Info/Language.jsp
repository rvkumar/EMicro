...
.text_field {
  ...
  <body>
	...
	<html:hidden name="approvalsForm" property="requestNumber" />
			...
			<logic:notEmpty name="langTempList">
           <logic:iterate id="abc1" name="langHistList">	
					 	<%
								JoiningFormalityForm empFormApp = (JoiningFormalityForm) abc1;
								%>
              <logic:iterate id="abc" name="langTempList">
				<%
				...
				<div id="language" style="width: 90%;">
					...
					<% if((!(empFormApp.getLanguage()== null) && !(empForm.getLanguage().equalsIgnoreCase(""))) || !(empForm.getLanguage()== null)&& !(empFormApp.getLanguage()== null)) 
                 {
                 %>
						<tr>
							<td><b>
							...
							<%} %>
						<% if((!(empFormApp.getMotherTongue()== null) && !(empForm.getMotherTongue().equalsIgnoreCase(""))) || !(empForm.getMotherTongue()== null)&& !(empFormApp.getMotherTongue()== null)) 
                 {
                 %>			<tr>
							<td><b>
								Mother Tongue</b>
							...
							<td>${abc.motherTongue}&nbsp;</td>
							<td>${abc1.motherTongue}&nbsp;</td>
							</tr>
							<%} %>
						<% if((!(empFormApp.getLangSpeaking()== null) && !(empForm.getLangSpeaking().equalsIgnoreCase(""))) || !(empForm.getLangSpeaking()== null)&& !(empFormApp.getLangSpeaking()== null)) 
                 {
                 %>			
						<tr>
							<td><b>
							...
							<td>${abc.langSpeaking}&nbsp;</td>
							<td>${abc1.langSpeaking}&nbsp;</td>
							</tr>
							<%} %>
						<% if((!(empFormApp.getLangRead()== null) && !(empForm.getLangRead().equalsIgnoreCase(""))) || !(empForm.getLangRead()== null)&& !(empFormApp.getLangRead()== null)) 
                 {
                 %>			<tr>
							<td><b>Reading</b><font color="red">*</font></td>
							<td>${abc.langRead}&nbsp;</td>
							<td>${abc1.langRead}&nbsp;</td>
						</tr>
						<tr>
						<td>${abc1.langRead}</td>
							...
							<%} %>
						<% if((!(empFormApp.getLangWrite()== null) && !(empForm.getLangWrite().equalsIgnoreCase(""))) || !(empForm.getLangWrite()== null)&& !(empFormApp.getLangWrite()== null)) 
                 {
                 %>			
						<tr>
							<td><b>
