...
.text_field {
 ...
 <logic:iterate id="abc1" name="addrHistory">	
					 	<%
								JoiningFormalityForm empFormApp = (JoiningFormalityForm) abc1;
								%>
              <logic:iterate id="abc" name="addrlist">
				<%
								JoiningFormalityForm empForm = (JoiningFormalityForm) abc;
				
				System.out.println("empFormApp id="+empFormApp.getId());
				System.out.println("empForm id="+empForm.getId());
			 ...
			 <% if((!(empFormApp.getAddressType()== null) && !(empForm.getAddressType().equalsIgnoreCase(""))) || !(empForm.getAddressType()== null)&& !(empFormApp.getAddressType()== null)) 
                 {
                 %>
						<tr>
							<td><b>
					...
					<%} %>
					<% if((!(empFormApp.getCareofcontactname()== null) && !(empForm.getCareofcontactname().equalsIgnoreCase(""))) || !(empForm.getCareofcontactname()== null)&& !(empFormApp.getCareofcontactname()== null)) 
                 {
                 %>
					<tr>
					<td><b>
								Care of / Contact name</b>
							</td>

							<td>
							${abc.careofcontactname}
							</td>
							<td>
							${abc1.careofcontactname}
							</td>
					</tr>
					<%} %>
					<% if((!(empFormApp.getHouseNumber()== null) && !(empForm.getHouseNumber().equalsIgnoreCase(""))) || !(empForm.getHouseNumber()== null)&& !(empFormApp.getHouseNumber()== null)) 
                 {
                 %>
					<tr>
							<td><b>
                          ...
                          <%} %>
					<% if((!(empFormApp.getAddressLine1()== null) && !(empForm.getAddressLine1().equalsIgnoreCase(""))) || !(empForm.getAddressLine1()== null)&& !(empFormApp.getAddressLine1()== null)) 
                 {
                 %>
                          ...
                          <%} %>
					<% if((!(empFormApp.getAddressLine2()== null) && !(empForm.getAddressLine2().equalsIgnoreCase(""))) || !(empForm.getAddressLine2()== null)&& !(empFormApp.getAddressLine2()== null)) 
                 {
                 %>
                          <tr>
                          ...
                          <%} %>
					<% if((!(empFormApp.getAddressLine3()== null) && !(empForm.getAddressLine3().equalsIgnoreCase(""))) || !(empForm.getAddressLine3()== null)&& !(empFormApp.getAddressLine3()== null)) 
                 {
                 %>
                          ...
                          <tr>
						    ...
						    <%} %>
					<% if((!(empFormApp.getPostalCode()== null) && !(empForm.getPostalCode().equalsIgnoreCase(""))) || !(empForm.getPostalCode()== null)&& !(empFormApp.getPostalCode()== null)) 
                 {
                 %><tr>
							<td><b>
								Postal Code</b>
							...
							${abc1.postalCode}
                              ...
                              <%} %>
					<% if((!(empFormApp.getCity()== null) && !(empForm.getCity().equalsIgnoreCase(""))) || !(empForm.getCity()== null)&& !(empFormApp.getCity()== null)) 
                 {
                 %>
						    ...
						    <%} %>
					<% if((!(empFormApp.getCountry()== null) && !(empForm.getCountry().equalsIgnoreCase(""))) || !(empForm.getCountry()== null)&& !(empFormApp.getCountry()== null)) 
                 {
                 %>
						    <tr>
							<td><b>
                            ...
                            <%} %>
					<% if((!(empFormApp.getState()== null) && !(empForm.getState().equalsIgnoreCase(""))) || !(empForm.getState()== null)&& !(empFormApp.getState()== null)) 
                 {
                 %><tr> 
							<td><b>
								State</b>
