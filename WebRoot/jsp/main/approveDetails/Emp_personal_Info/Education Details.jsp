...
.text_field {
  ...
  <body>
	...
	<logic:notEmpty name="eduTempList">
               <logic:iterate id="abc1" name="eduHistList">	
					 	<%
								JoiningFormalityForm empFormApp = (JoiningFormalityForm) abc1;
								%>
              <logic:iterate id="abc" name="eduTempList">
				<%
		...
		<% if((!(empFormApp.getEducationalLevel()== null) && !(empForm.getEducationalLevel().equalsIgnoreCase(""))) || !(empForm.getEducationalLevel()== null)&& !(empFormApp.getEducationalLevel()== null)) 
                 {
                 %>
						<tr>
							<td><b>
							...
							<td>
							${abc.educationalLevel}
								</td>
								<td>${abc1.educationalLevel}</td>
							</tr>
							<%} %>
						<% if((!(empFormApp.getQualification()== null) && !(empForm.getQualification().equalsIgnoreCase(""))) || !(empForm.getQualification()== null)&& !(empFormApp.getQualification()== null)) 
                 {
                 %>			
							<tr>
							<td><b>
							...
							<td>${abc.qualification}
								
							</td>
<td>${abc1.qualification}</td>
							</tr>
							<%} %>
						<% if((!(empFormApp.getUniversityName()== null) && !(empForm.getUniversityName().equalsIgnoreCase(""))) || !(empForm.getUniversityName()== null)&& !(empFormApp.getUniversityName()== null)) 
                 {
                 %>			
						<tr>
							...
							<td>${abc.universityName}
							</td>
							<td>${abc1.universityName}</td>
							</tr>
							<%} %>
						<% if((!(empFormApp.getUniverysityLocation()== null) && !(empForm.getUniverysityLocation().equalsIgnoreCase(""))) || !(empForm.getUniverysityLocation()== null)&& !(empFormApp.getUniverysityLocation()== null)) 
                 {
                 %>			
							<tr>
							<td><b>
								University Location</b>
							</td>
							<td>${abc.univerysityLocation}
								
							</td>
				<td>${abc1.univerysityLocation}</td>
							</tr>
							<%} %>
						<% if((!(empFormApp.getEdcountry()== null) && !(empForm.getEdcountry().equalsIgnoreCase(""))) || !(empForm.getEdcountry()== null)&& !(empFormApp.getEdcountry()== null)) 
                 {
                 %>			
						<tr>
							<td><b>
...
<td>${abc1.edcountry}</td>
							</tr>
							<%} %>
						<% if((!(empFormApp.getEdstate()== null) && !(empForm.getEdstate().equalsIgnoreCase(""))) || !(empForm.getEdstate()== null)&& !(empFormApp.getEdstate()== null)) 
                 {
                 %>			
							<tr>
							<td><b>
						...
						<td>${abc1.edstate}</td>
							...
							<%} %>
						<% if((!(empFormApp.getDurationofCourse()== null) && !(empForm.getDurationofCourse().equalsIgnoreCase(""))) || !(empForm.getDurationofCourse()== null)&& !(empFormApp.getDurationofCourse()== null)) 
                 {
                 %>			
						<tr>
							<td><b>
								Duration of Course</b>
							</td>
							<td >${abc.durationofCourse}
							</td>
					<td>${abc1.edstate}</td>
							</tr>
							<%} %>
						<% if((!(empFormApp.getFromDate()== null) && !(empForm.getFromDate().equalsIgnoreCase(""))) || !(empForm.getFromDate()== null)&& !(empFormApp.getFromDate()== null)) 
                 {
                 %>			
						<tr>
							...
							<%} %>
						<% if((!(empFormApp.getToDate()== null) && !(empForm.getToDate().equalsIgnoreCase(""))) || !(empForm.getToDate()== null)&& !(empFormApp.getToDate()== null)) 
                 {
                 %>			
							<tr>
							<td><b>
					...
					<td>${abc1.toDate}</td>
							...
							<%} %>
						<% if((!(empFormApp.getFullTimePartTime()== null) && !(empForm.getFullTimePartTime().equalsIgnoreCase(""))) || !(empForm.getFullTimePartTime()== null)&& !(empFormApp.getFullTimePartTime()== null)) 
                 {
                 %>			
						<tr>
							...
							<td>${abc.fullTimePartTime}
								
							</td>
							<td>${abc1.fullTimePartTime}</td>
							</tr>
							<%} %>
						<% if((!(empFormApp.getPercentage()== null) && !(empForm.getPercentage().equalsIgnoreCase(""))) || !(empForm.getPercentage()== null)&& !(empFormApp.getPercentage()== null)) 
                 {
                 %>			
							<tr>
							<td><b>
							...
							<td ><b>
								...
								<%
								 empForm = (JoiningFormalityForm) abc;
								%>
