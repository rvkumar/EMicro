...
<body style="text-transform: uppercase;">
	...
	<table class="bordered">
		...
		<tr>
			...
			<td>
			<html:text property="serviceDescription" maxlength="40" style="width:400px;text-transform:uppercase" readonly="true"></html:text>
			...
			<td colspan="3">
				<html:textarea name="approvalsForm" property="detailedServiceDescription" style="width:400px;text-transform:uppercase"  styleClass="content" rows="3" cols="80" readonly="true"></html:textarea>
			</td>
		</tr>

		<tr>
			<td>U O M <font color="red">*</font></td>
			<td><html:select  name="approvalsForm" property="uom" styleClass="content" disabled="true">
					<html:option value="">--Select--</html:option>
			...
			<td><html:select name="approvalsForm" property="purchaseGroup" styleClass="content" disabled="true">
					<html:option value="">--Select--</html:option>
		...
		<tr>
			...
			<td><html:select name="approvalsForm" property="serviceCatagory" styleClass="content" onchange="getValuationClass()" disabled="true">
					<html:option value="">--Select--</html:option>
			...
			<td>
			<html:select  name="approvalsForm" property="serviceGroup" styleClass="content" disabled="true">
					<html:option value="">--Select--</html:option>
		...
		<tr>
			...
			<td>
				<html:text name="approvalsForm" property="e_m_name" styleClass="content" maxlength="16" style="width:300px;" readonly="true"></html:text>
			</td>
			<td>Approximate Value </td>
			<td>
				<html:text name="approvalsForm" property="app_amount" styleClass="content"  maxlength="16" style="width:400px;text-transform:uppercase" readonly="true"></html:text>
			</td>
		</tr>
		...
		<tr>
			...
			<td colspan="3">
				<html:textarea  name="approvalsForm"  property="justification" styleClass="content" rows="3" cols="80" style="width:400px;text-transform:uppercase" readonly="true"></html:textarea>
			</td>
		</tr>
