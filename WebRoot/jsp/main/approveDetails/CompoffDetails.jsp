...
function changeStatus(elem){
	...
	var reqId = document.getElementById("reqId").value;;
	var reqType = document.getElementById("reqType").value;
	var url="approvals.do?method=statusChangeCompOff&reqId="+reqId+"&reqType="+reqType+"&status="+elemValue;
...
<div align="center" id="messageID" style="visibility: visible;">
		...
		<table class="bordered" width="90%">
			<tr>
				<th colspan="5" align="left"><center> Comp-Off Approval Form</center></th>
			</tr>
		...
		<tr>
			...
			<%-- <td width="15%">To Date <font color="red" size="3">*</font></td>
						...
						<td width="15%">Comp Off Type <font color="red" size="3">*</font></td> 
							...
							<td align="left" width="34%">
							<bean:write name="approvalsForm" property="reasonType"/>
							</td>	
			</tr>
					<tr>
			...
			<tr>	
							...
							<html:textarea property="reason" cols="100" rows="10" style="height: 57px;color:black; width: 874px" disabled="true" ></html:textarea>
