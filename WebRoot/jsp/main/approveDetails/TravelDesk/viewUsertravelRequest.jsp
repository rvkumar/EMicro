...
function changeStatus(elem){
	...
	var url="approvals.do?method=statusChangeTravelRequest&reqId="+reqId+"&reqType="+reqType+"&status="+elemValue;
...
<tr>
				...
				<tr>
					...
					<td colspan="3">
					<logic:notEmpty name="abc" property="filepath">
			...
			<table class="bordered" style="position: relative;left: 2%;width: 90%;">
			<tr><th colspan="9">Other Details</th></tr>
			
			<tr>
			<th>Guest Name</th>
			<th>Accomodation</th>
			<th>Accomodation Type</th>
			<th>Rental Car required</th>
...
<td>${abcp4.remarks}<input name="mremarks" value="${abcp4.remarks}" type="hidden">
			...
			<html:textarea property="comments" style="width:800px;" ></html:textarea>	</td></tr>
   	...
   	<table style="border:0px; margin-left: 30% ;">
	<tr><td colspan="2" >
		   ...
		   <logic:notEmpty name="approveButton">
			...
			<logic:notEmpty name="revertbutton">
			<input type="button" class="rounded" value="Revert" onclick="changeStatus(this)" />&nbsp;&nbsp;
			</logic:notEmpty>
