...
function changeStatus(elem){
	...
	var url="approvals.do?method=statusChangeConference&reqId="+reqId+"&reqType="+reqType+"&status="+elemValue;
...
function checkAvailability(){
	window.showModalDialog("approvals.do?method=checkConferenceAvail",window.location, "dialogWidth=950px;dialogHeight=500px; center:yes");
