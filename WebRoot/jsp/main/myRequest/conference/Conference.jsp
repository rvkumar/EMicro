...
<script type="text/javascript" src="js/sorttable.js"></script>
   ...
   <link rel="stylesheet" type="text/css" href="style3/css/TableCSS.css" />
      ...
      function cancelConference(){
    	  ...
    	  var url="myRequest.do?method=cancelConferenceRequest&requestNo="+reqNo;
...
<td><b>IP Address:</b></td><td ><bean:write name="c" property="IPNumber"/></td></tr>
	...
	<html:button property="method" value="Cancel Request" styleClass="rounded" onclick="cancelConference()"/>&nbsp;
