...
*/
    ...
    alert ("Please Remove Single Code(') in  Batch Code!");
     document.forms[0].batchCode.focus(); 
 return false;
 }}
	  ...
	  /*   if(document.forms[0].sapCodeNo.value=="")
	    ...
	    */
			...
			var url="semifinished.do?method=saveSemiFinished";
			document.forms[0].action=url;
			document.forms[0].submit();		 
}
...
<body style="text-transform:uppercase;">
  ...
  <div class="middel-blocks">
          ...
          <logic:iterate id="semiFinshedForm" name="semidetails">
	
	
	<div id="materialTable" style="visibility: visible;">
			<table class="bordered">
		<tr>
			<th colspan="8"><center><big>Material Code Request Form</big></center></th>
		</tr>
			...
			<tr>
				...
				<td>										
				<bean:write name="semiFinshedForm" property="requestNo"/>

				</td>
				<td>Request Date <font color="red">*</font></td>
				<td colspan="8">
				<bean:write name="semiFinshedForm" property="requestDate"/>
				</td>
			</tr>

			<tr>
				<td>Location <font color="red">*</font></td>
				<td>				<bean:write name="semiFinshedForm" property="locationId"/>
...
<%--				<br /></td>
				...
				<td colspan="8">							
				<bean:write name="semiFinshedForm" property="storageLocationId"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td colspan="4">
				<bean:write name="semiFinshedForm" property="materialShortName"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td colspan="4" >
				<bean:write name="semiFinshedForm" property="materialLongName"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td colspan="1">
										<bean:write name="semiFinshedForm" property="materialGroupId"/></td>

<td>
				&nbsp;&nbsp;U O M <font color="red">*</font></td>
				<td>
				<bean:write name="semiFinshedForm" property="unitOfMeasId"/>
				...
				<td colspan="4">				
				<bean:write name="semiFinshedForm" property="packSize"/>
			...
			<tr>
				<td>Country </td>
				<td>			
					<bean:write name="semiFinshedForm" property="countryId"/>

				</td>
				<td>Customer Name <font color="red">*</font></td>
				<td colspan="8">
					<bean:write name="semiFinshedForm" property="customerName"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td >
									<bean:write name="semiFinshedForm" property="shelfLife"/>
									<bean:write name="semiFinshedForm" property="shelfType"/>

				</td>
				<td>Retest Days <font color="red">*</font></td>
				<td colspan="8">
			
					<bean:write name="semiFinshedForm" property="retestDays"/>
                   <bean:write name="semiFinshedForm" property="retestType"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
                   <bean:write name="semiFinshedForm" property="standardBatchSize"/>
               </td>
				<td>Batch Code <font color="red">*</font></td>
				<td>
                   <bean:write name="semiFinshedForm" property="batchCode"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
                   <bean:write name="semiFinshedForm" property="targetWeight"/>
				</td>
			...
			<tr-->
				...
				<td>
			  <bean:write name="semiFinshedForm" property="weightUOM"/>
			...
			<tr>
				...
				<td>
							  <bean:write name="semiFinshedForm" property="valuationClass"/>
...
<tr>			
	<th colspan="6">Material Code Details:</th>
	 		  ...
	 		  <tr>
				...
				<td>
				<bean:write name="semiFinshedForm" property="sapCodeExists"/>
				</td>
		
			<td >SAP Code No<img src="images/star.gif" width="8" height="8" /></td>
				<td colspan="4"><bean:write name="semiFinshedForm" property="sapCodeNo"/>	</td>
			...
			<td align="left">
				<bean:write name="semiFinshedForm" property="sapCreationDate"/>
				
			</td>
			
				<td >Code Created By<img src="images/star.gif" width="8" height="8" /></td><td colspan="4">
				<bean:write name="semiFinshedForm" property="sapCreatedBy"/>
