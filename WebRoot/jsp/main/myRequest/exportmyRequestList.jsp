...
<body>
	<div id="wraper">   
    	<div style="padding-left:15px; width: 100%;" class="content_middle">
				...
				<logic:notEmpty name="vcList">
				    <table class="sortable bordered">
				     ...
				     <th>Last Approver</th><th>Pending Approver</th><th>Approval Status</th>
				     </tr>
			...
			<table class="sortable bordered">
				...
				<a href="myRequest.do?method=editMyRequest&requestNo=${mytable1.requestNumber}&type=OnDuty"/>
					...
					<th>To Storage Location</th><th>Last Approver</th><th>Pending Approver</th><th>Status</th>
					</logic:equal>
					...
					<th>Req. No</th><th>Requested On</th><th>Request Type</th><th>From Time</th> <th>To Time</th><th>Approver</th><th>Status</th>
					</logic:equal>
