...
<logic:iterate id="itHelpdeskForm" name="folder">
...
<td colspan="2" ><bean:write name="itHelpdeskForm" property="requiredfoldername"/>
</td>
...
<bean:write name="itHelpdeskForm" property="accesstype"/>
</td>
<td><b>Asset Details:</b></td>
<td colspan="4">
<bean:write name="itHelpdeskForm" property="assetvalue"/>
