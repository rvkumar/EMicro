...
for (var i = 0; i < materialShortName.length; i++) {
 ...
 return false;
        ...
        if (!pattern.test(approximateValue)) {
             alert("ApproximateValue  Should be Integer or Float ");
                 document.forms[0].approximateValue.focus();
            return false;
        }
 ...
 return false;
	    ...
	    */
			var url="promotional.do?method=savePromotional";
			document.forms[0].action=url;
			document.forms[0].submit();		 
}
...
<body style="text-transform:uppercase;">
	...
	<html:form action="/promotional.do" enctype="multipart/form-data">
            ...
            <logic:iterate id="promotionalForm" name="prodetails">
			...
			<tr>
				...
				<td>
				<bean:write name="promotionalForm" property="requestNo"/>
				</td>
				<td>Request Date <font color="red">*</font></td>
				<td>
				<bean:write name="promotionalForm" property="requestDate"/>
				</td>
			</tr>
			<tr>
				<td>Location <font color="red">*</font></td>
				<td>
			<bean:write name="promotionalForm" property="locationId"/>
							</td>
...
<%--				</td>--%>
				...
				<td>
				<bean:write name="promotionalForm" property="storageLocationId"/>
			...
			<tr>
				...
				<td colspan="3">
				<bean:write name="promotionalForm" property="materialShortName"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td colspan="3" >
				<bean:write name="promotionalForm" property="materialLongName"/>
				</td>
			</tr>
			...
			<tr>
				...
				<bean:write name="promotionalForm" property="materialGroupId"/>
				
			
				</td>
				<td>Purchase&nbsp;Group <font color="red">*</font></td>
				<td>
								<bean:write name="promotionalForm" property="puchaseGroupId"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td >
												<bean:write name="promotionalForm" property="unitOfMeasId"/>
				
				</td>
				<td>Division <font color="red">*</font></td>
				<td>											
					<bean:write name="promotionalForm" property="divisionId"/>
		   ...
		   <td>
		  					<bean:write name="promotionalForm" property="isAsset"/>
		  
					</td>
				<td>Purpose <font color="red">*</font></td>
				<td>		  				
					<bean:write name="promotionalForm" property="purposeID"/>
				...
				<td colspan="3">
									<bean:write name="promotionalForm" property="isSASFormAvailable"/>
			...
			<tr>
				...
				<td>
									<bean:write name="promotionalForm" property="approximateValue"/>
				</td>
				<td>Valuation&nbsp;Class <font color="red">*</font></td>
				<td>
													<bean:write name="promotionalForm" property="valuationClass"/>
			...
			<tr>
				...
				<td>
				<bean:write name="promotionalForm" property="detailedJustification"/>
				
				</td>
				<td>Specification <font color="red">*</font></td>
				<td>
				<bean:write name="promotionalForm" property="detailedSpecification"/>
	...
	<th colspan="6">Material Code Details:</th>
	 		  ...
	 		  <tr>
				...
				<td>
				<bean:write name="promotionalForm" property="sapCodeExists"/>
				</td>
		
			<td >SAP Code No<img src="images/star.gif" width="8" height="8" /></td>
				<td colspan="4"><bean:write name="promotionalForm" property="sapCodeNo"/>	</td>
			...
			<td align="left">
				<bean:write name="promotionalForm" property="sapCreationDate"/>
				
			</td>
			
				<td >Code Created By<img src="images/star.gif" width="8" height="8" /></td><td colspan="4">
				<bean:write name="promotionalForm" property="sapCreatedBy"/>
