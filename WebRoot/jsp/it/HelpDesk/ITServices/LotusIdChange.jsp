...
$(function() {
	$('#mailIDRetainedID').datepick({dateFormat: 'dd/mm/yyyy'});
	$('#inlineDatepicker2').datepick({onSelect: showDate});
});
$(function() {
...
function saveData()
{
  ...
  var st = document.forms[0].fromemailId.value;
	...
	document.forms[0].fromemailId.value=st;
	 ...
	 if(document.forms[0].newlyJoinedYes.checked==false && document.forms[0].newlyJoinedNo.checked==false)
	    {
	      alert("Please Select Yes Or NO In Newly Joined");
	      document.forms[0].newlyJoinedNo.focus();
	         return false;
	    }
	 if(document.forms[0].newlyJoinedYes.checked==true){
		 if(document.forms[0].joiningDate.value==""){
			 alert("Please Select Joining Date");
		      document.forms[0].joiningDate.focus();
		      return false;
		 }
	 }
...
<tr>
<td><b>From Email Id:&nbsp;<font color="red" >*</font></b></td><td colspan="3"><html:text  name="itHelpdeskForm" property="fromemailId" style="width:50%;"></html:text></td>
...
<tr>
<td><b>Suggested Email Id:&nbsp;<font color="red" >*</font></b></td><td colspan="3"><html:text  name="itHelpdeskForm" property="suggestedEmailId" style="width:50%;"></html:text></td></tr>
<tr>
...
<td><b>Enable Web Access:&nbsp;</b></td><td><html:select property="enablewebAccess" styleClass="content" styleId="filterId" >
	...
	<tr><td ><b>Reason:&nbsp;<font color="red" >*</font></b></td>
<td colspan="3"><html:textarea property="reason" name="itHelpdeskForm" cols="70" rows="4">
