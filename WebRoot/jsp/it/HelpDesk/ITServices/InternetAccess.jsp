...
<tr><td><b>AD Login Name:&nbsp;</b></td><td colspan="4"><html:text  name="itHelpdeskForm" property="adloginname" style="width:50%;"></html:text></td></tr>
<tr>
...
<%--<tr><td><b>Internet Group / Category:</b></td><td colspan="3">--%>
...
<td colspan="3"><html:textarea property="reason" name="itHelpdeskForm" cols="75" rows="5">
