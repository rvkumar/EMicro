...
<td><html:select property="assetcategory" styleClass="content" styleId="filterId" onchange="display()">
	...
	<html:options labelProperty="spareLabelList" property="spareLabelList" name="itHelpdeskForm"></html:options>
...
<td colspan="3"><html:text  name="itHelpdeskForm" property="apprxvalue" ></html:text></td>
