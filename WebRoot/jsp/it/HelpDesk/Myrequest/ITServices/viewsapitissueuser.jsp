...
<bean:write name="myRequestForm" property="requestStatus"/>
 ...
 <td>Request No</td> 
 <td><bean:write name="myRequestForm" property="requestNo"/></td>
</tr>
<tr>
...
<td><b>Sub-Category</b> <font color="red">*</font></td>
			...
			<logic:notEmpty name="renameId">
						<tr>
						<td>Exiting ID</td>
						<td><bean:write name="myRequestForm" property="oldId"/></td>
							<td>Proposed ID</td>
						<td><bean:write name="myRequestForm" property="newId"/></td>
						</tr>
						...
						<td colspan="4"><bean:write name="myRequestForm" property="roleId"/></td>
						</tr></logic:notEmpty>
