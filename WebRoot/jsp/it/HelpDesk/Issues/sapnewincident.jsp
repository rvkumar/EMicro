...
function sapUploadDocument()
{
	...
	document.forms[0].action="itIsssues.do?method=sapUploadDocuments&subCategory="+subCategory+"&technician="+technician;
	document.forms[0].submit();
}
function sapDeleteDocumentsSelected()
{
...
if(agree)
{
	...
	var technician="";
	 subCategory=document.forms[0].subCategory.value;
	 technician=document.forms[0].techinician.value;
	document.forms[0].action="itIsssues.do?method=sapDeleteDocuments&cValues="+checkvalues+"&subCategory="+subCategory+"&technician="+technician;
document.forms[0].submit();
}
}
}
function back(){
	document.forms[0].action="itIsssues.do?method=displayAllSapIssues";
	document.forms[0].submit();
}
...
<tr><th colspan="4"><center><big>SAP </big></center></th></tr>
...
<td><b>Category</b> <font color="red">*</font></td>
						...
						<html:select property="category" styleClass="content"  onchange="getSubcat(this.value)">
							<html:option value="">-----Select---------</html:option>
							<html:options name="issuesForm"  property="categortShortlist" labelProperty="categorylist"/>
							</html:select>
						</td>
...
<tr>
            <th  colspan="4" align="center">Document Path : 
                ...
                <html:button property="method" styleClass="rounded"  value="Upload" onclick="sapUploadDocument();" style="align:right;width:100px;"/>
          ...
          <tr>
						...
						<tr>
							...
							<html:button property="method" value="Delete" onclick="sapDeleteDocumentsSelected()" styleClass="rounded"/>
							</td>
							</tr>
						</logic:notEmpty>
...
<td colspan="4" style="text-align: center;">
	<html:button property="method"  value="Submit" onclick="submitData()" styleClass="rounded" style="width: 100px"></html:button>&nbsp;&nbsp;
