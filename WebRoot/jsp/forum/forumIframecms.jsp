   		...
   		<tr>
    		...
    		<html:form action="hr.do" enctype="multipart/form-data">
    			<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
    				<tr>
          				<td align="left"><bean:write name="forumForm" property="contentDescription" filter="false" /></td>
          			</tr>
          			<tr>
          				<td>
          				<logic:notEmpty name="forumForm" property="fileFullPath">
          				...
          				<bean:define id="file" name="forumForm" property="fileFullPath" />
								<%
									...
									<logic:notEmpty name="forumForm" property="videoFullPath">
...
String getImages="select * from archieves where link_name='Forum' and module='Main' and status='null' order by month desc";
