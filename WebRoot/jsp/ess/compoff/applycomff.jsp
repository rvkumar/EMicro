...
alert("Please Select Comp Off Type");
		...
		<tr>
			...
			<%-- <td width="15%">To Date <font color="red" size="3">*</font></td>
							...
							<html:text property="endDate" styleId="popupDatepicker2" styleClass="text_field" readonly="true" />
							 ...
							 <td>Comp Off Type	 <font color="red" size="3">*</font></td><td>
...
<td><a href="#" ><img src="images/delete.png"   onclick="deleteRow()" title="Remove Row"/></a></td>
      ...
      <bean:write property="employeeNumber" name="leaveForm" /></html:text><a href="#"><img  src="images/search.png" title="search"  align="absmiddle" onclick="searchEmployeeId(this.id)" id="employeeNumber1" style="height: 20px; width: 21px; "/></a>    
	...
	<tr>
	<th>Employee No</th><th>Name</th><th>Designation</th>	
	</tr>
	<tr><td>${leaveForm.employeeNumber}</td><td>${leaveForm.employeeName}</td><td>${leaveForm.designation}</td></tr>
