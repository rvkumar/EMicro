...
<div align="center" id="messageID" style="visibility: visible;">
		...
		<table class="bordered" width="90%">
			<tr>
				<th colspan="7" align="left"><center>Comp-Off Drafts</center></th>
			</tr>
		<tr>
<th>Req&nbsp;No</th><th>Request Date</th><th >&nbsp;&nbsp;&nbsp;&nbsp;Date</th><th>Reason</th><th>Status</th><th>Edit</th>
</tr>
...
<td>
<a  href="leave.do?method=editcompoff&requstNo=<bean:write name="c" property="requestNumber"/>" ><img src="images/edit1.jpg"/></a>
</td>
</tr>
		</logic:iterate>	
		</logic:notEmpty>
