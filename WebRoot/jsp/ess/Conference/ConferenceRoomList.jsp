...
function searchConfRoom(){
	...
	var url="conference.do?method=searchConfRoom";
...
<html:select  property="roomName">
	...
	<div>&nbsp;</div>
	 <input type="button" value="Book Conference Room" class="rounded" onclick="bookRoom()"/>&nbsp;&nbsp;&nbsp;
	 <input type="button" value="Conference Rooms List" class="rounded" onclick="roomsList()"/>
	<div>&nbsp;</div>
...
<table class="bordered">
 ...
 <tr><td colspan="8"><center><b><font color="green">Conference Room Available</font></b></center></td></tr>
 </table>
</logic:notEmpty>
