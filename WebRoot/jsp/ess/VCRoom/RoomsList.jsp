...
select:focus { 
 ...
 function serarchLocation(){
	 ...
	 var url="vc.do?method=searchRoomsList";
		document.forms[0].action=url;
		document.forms[0].submit();
 }
 function clearSearch(){
	 
	 var url="vc.do?method=roomsList";
		document.forms[0].action=url;
		document.forms[0].submit();
 }
 ...
 <table class="bordered" >
 <tr><th colspan="8"><center>Available VC Rooms</center> </th></tr>
 <tr>
 <th>Location</th><th>Floor</th><th>VC Name</th>
 </tr> 
 ...
 <tr>
 <td colspan="3"><font color="red"><center><bean:write name="vcForm" property="message2"/></center></font> </td>
 </tr>
 </logic:notEmpty>
 </table>
 </div>
