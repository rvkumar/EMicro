...
xmlhttp.open("POST","leave.do?method=leavereason&LeaveType="+leaveType,true);
xmlhttp.send();
}
...
return false;
 ...
 document.forms[0].action="leave.do?method=submit&year="+year+"&param="+param+"&noOfDays="+totalLeaveDays;
document.forms[0].submit();
}
 if(param=='Draft')
{
...
function closeLeave()
{
	document.forms[0].action="leave.do?method=displayRequests&sId=ApplyLeave&id=ESS";
	document.forms[0].submit();
}
...
var xmlhttp;
    ...
    xmlhttp.onreadystatechange=function(){
     ...
     xmlhttp.open("POST","leave.do?method=displaycompofflist&LeaveType="+leaveType+"&StartDate="+startDate,true);
    xmlhttp.send();
...
<body>
	...
	<%@taglib uri="/WEB-INF/tlds/struts-html.tld" prefix="html"%><html:form action="leave" enctype="multipart/form-data">
	<div id="masterdiv" class="">
		...
		<br/>
			...
			<display:table name="leaveDetails"  requestURI="/leave.do" pagesize="10" 
			...
			<display:table name="leaveDraftDetails" requestURI="/leave.do" 
			 ...
			 <display:column property="id" href="leave.do?method=selectContent" paramId="id" title="Request No." sortable="true"   />
            <display:column property="startDate" title="Start Date" sortable="true"  />
            <display:column property="endDate" title="End Date" sortable="true"  />
            <display:column property="noOfDays" title="No Of Days" sortable="true"  />
       ...
       <html:button property="method"  value="Cancel Request" onclick="cancelRequest()"/>
			...
			<display:table name="leaveEmpDetails" requestURI="/leave.do" pagesize="10"  id="mytable1" >
			
			<display:column property="id"  href="leave.do?method=selectRequest" paramId="requstNo"  title="Req No" sortable="true"   />
