...
if(agree)
{
	document.forms[0].action="previousIncome.do?method=deleteDocuments&cValues="+checkvalues;
...
document.forms[0].action="previousIncome.do?method=uploadDocuments&filedesc="+x;
	document.forms[0].submit();
...
<body>
<html:form action="/previousIncome.do" enctype="multipart/form-data" method="post">
<div align="center" id="messageID" style="visibility: true;">
				<logic:present name="previousIncomeForm" property="message2">
			
				<script language="javascript">
					statusMessage('<bean:write name="previousIncomeForm" property="message2" />');
					</script>
				</logic:present>
...
<tr><td colspan="10"><font color="red">Note:All Supporting Previous Income Documents should be scanned PDF Documents. Without Supporting Previous Income Documents request will not be considered for submission </font></td></tr>
        <tr >
		...
		<tr>
						...
						<tr>
							...
							<td colspan="3">
								<a href="/EMicro Files/ESS/Income Tax/Previous Income/UploadFiles/${abc.fileName}"  target="_blank">  <bean:write name="abc" property="fileName"/></a>
							</td>
