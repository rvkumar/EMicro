...
if(agree)
{
	document.forms[0].action="lta.do?method=deleteMedicalDocuments&cValues="+checkvalues;
...
document.forms[0].action="lta.do?method=uploadMedicalDocuments&filedesc="+x;
	document.forms[0].submit();
...
<body>
<html:form action="/lta.do" enctype="multipart/form-data" method="post">
<div align="center" id="messageID" style="visibility: true;">
				<logic:present name="ltaForm" property="message2">
			
				<script language="javascript">
					statusMessage('<bean:write name="ltaForm" property="message2" />');
					</script>
				</logic:present>
...
<table class="bordered">
     <tr><td colspan="10"><font color="red">Note:All  Medical Bills must be supported by attaching the scanned PDF Documents. Without Supporting Medical Documents request<br/> will not be considered for IT submission </font></td></tr>
      <tr >
		...
		<tr>
						...
						<tr>
							...
							<td colspan="3">
								<a href="/EMicro Files/ESS/Income Tax/Medical/UploadFiles/${abc.fileName}"  target="_blank">  <bean:write name="abc" property="fileName"/></a>
							</td>
