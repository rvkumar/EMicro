...
if(agree)
{
	document.forms[0].action="claimTRLP.do?method=deleteDocuments&cValues="+checkvalues;
...
document.forms[0].action="claimTRLP.do?method=uploadDocuments&filedesc="+x;
	document.forms[0].submit();
...
<div align="center" id="messageID" style="visibility: true;">
				<logic:present name="claimTRLPForm" property="message2">
			
				<script language="javascript">
					statusMessage('<bean:write name="claimTRLPForm" property="message2" />');
					</script>
				</logic:present>
...
<tr><td colspan="10"><font color="red">Note:All  HRA must be supported by attaching the scanned PDF Documents. Without Supporting HRA Documents request will not be considered for IT submission </font></td></tr>
        <tr >
		...
		<tr>
						...
						<tr>
							...
							<td colspan="3">
								<a href="/EMicro Files/ESS/Income Tax/Claim TRLP/UploadFiles/${abc.fileName}"  target="_blank">  <bean:write name="abc" property="fileName"/></a>
							</td>
