...
document.forms[0].action="lta.do?method=uploadDocuments&filedesc="+x;
	document.forms[0].submit();
...
<tr><td colspan="10"><font color="red">Note:All  LTA must be supported by attaching the scanned PDF Documents. Without Supporting LTA Documents request will not be considered for IT submission </font></td></tr>
        <tr >
		...
		<tr>
						...
						<tr>
							...
							<td colspan="3">
								<a href="/EMicro Files/ESS/Income Tax/LTA/UploadFiles/${abc.fileName}"  target="_blank">  <bean:write name="abc" property="fileName"/></a>
							</td>
