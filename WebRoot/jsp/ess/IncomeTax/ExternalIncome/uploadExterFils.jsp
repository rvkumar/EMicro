...
if(agree)
{
	document.forms[0].action="extIncome.do?method=deleteDocuments&cValues="+checkvalues;
...
document.forms[0].action="extIncome.do?method=uploadDocuments&filedesc="+x;
	document.forms[0].submit();
...
<body>
<html:form action="/extIncome.do" enctype="multipart/form-data" method="post">
...
<tr><td colspan="10"><font color="red">Note:All  External Income/Deduction must be supported by attaching the scanned PDF Documents. Without Supporting External Income Documents request will not be considered for IT submission </font></td></tr>
        <tr >
		...
		<tr>
						...
						<tr>
							...
							<td colspan="3">
								<a href="/EMicro Files/ESS/Income Tax/External Income/UploadFiles/${abc.fileName}"  target="_blank">  <bean:write name="abc" property="fileName"/></a>
							</td>
