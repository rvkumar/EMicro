...
function searchRequest()
{
	...
	document.forms[0].action="vc.do?method=myraiserequest";
...
<body >
	...
	<th>To Date<font color="red">*</font></th><td> <html:text property="toDate" styleId="popupDatepicker2"/></td>
	</tr>
	<tr>
	<th>
	Req Status
	...
	<td colspan="8"><center> <html:button property="method" value="Search" onclick="searchRequest()" styleClass="rounded"/> &nbsp;&nbsp;
	...
	<div>&nbsp;</div>
			...
			<table class="sortable">
				...
				<tr>
				<th colspan="11"><center>Asisgned Details</center></th>
				</tr>
			<tr>
			...
			<th style="text-align:left;"><b>Status</b></th>
				...
				<tr>
				<td>
				<a href="vc.do?method=viewmyraiserequest&reqno=<bean:write name="mytable1" property="id"/>" title="View"><bean:write name="mytable1" property="reqNo"/>
				</a>
					</td>
				<td>
