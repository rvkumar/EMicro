...
{
	document.forms[0].action="onDuty.do?method=uploadDocuments";
...
if(agree)
{
	document.forms[0].action="onDuty.do?method=deleteDocuments&cValues="+checkvalues;
document.forms[0].submit();
}
}
}
...
{ 
 ...
 {
  alert("In time Minutes should be greater than  Out Time Minutes");
...
endYear=endYear[2];
	...
	if(endYear>newyear){
	alert("Next year Requests cannot be applied in Advance");
	document.forms[0].endDate.value="";
	return false;
...
alert("Purpose should  be less than 300 characters");
return false;
   }
...
function closeLeave()
{
	document.forms[0].action="onDuty.do?method=displayOnDutyRequests";
	document.forms[0].submit();
}
...
<body >
	...
	<html:hidden property="submitDate" />
		<div align="center" id="messageID" style="visibility: visible;">
			<logic:present name="onDutyForm" property="message">
				<font color="green" size="3"><b><bean:write name="onDutyForm" property="message" /></b></font>
				
			</logic:present>
			<logic:present name="onDutyForm" property="message2">
				<font color="red" size="3"><b><bean:write name="onDutyForm" property="message2" /></b></font>
		...
		<table class="bordered content" width="90%">
			 <tr><th  colspan="4" align="center">
					<center>Apply OnDuty</center></th>
  						<tr>
  							<td width="15%">On Duty Type <font color="red" size="3">*</font></td>
							<td width="64%" align="left" >
								<html:select name="onDutyForm" property="onDutyType" styleClass="text_field" onchange="checkType()">
						
									<html:option value="">--Select--</html:option>
							<html:options name="onDutyForm" property="ondutyvalue" labelProperty="ondutyreason"/>
								
									</html:select>
							</td>
							<td>Plant<div style="visibility: hidden;width: 1%" id="plant"><font color="red" size="1">*</font></div></td>  
			<td >
	  				...
	  				<html:options property="locationIdList" labelProperty="locationLabelList" ></html:options>   
						...
						<tr>
							...
							<td align="left" width="34%">
								<html:text property="startDate"  styleId="popupDatepicker" styleClass="text_field"/>
							</td>
   ...
   String time=Integer.toString(a)+":"+Integer.toString(b);     

  
%>
							
								<td>				
					<p> Out&nbsp;Time<font color="red" size="3">*</font> </td><td><html:text property="startTime" styleId="timeFrom"  size="15" value="<%=time %>"/></p></td>
						</tr>
						<tr>
							<td width="15%">To Date <font color="red" size="3">*</font></td>
							
							<td align="left" width="34%">
							<html:text property="endDate"  styleId="popupDatepicker2" styleClass="text_field" />
							</td>
							
							
							<td><p>In&nbsp;Time<font color="red" size="3">*</font> </td>
							<td><html:text property="endTime"  styleId="timeTo"   size="15" value="06:00PM"/></p>
							</tr>
							
						<tr>
				<th colspan="4"> Detailed Purpose<font color="red" size="2"> * </font> Max(300 char) : 
						</th>
						</tr>
						<tr>	
		...
		<html:hidden property="requestNumber"/>
				<html:hidden property="applyAfterDate"/>
				</div>
	</html:form>
