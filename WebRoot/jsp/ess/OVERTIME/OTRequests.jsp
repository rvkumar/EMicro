...
var url="leave.do?method=selfcancelOTRecord&reqno="+reqno;
			document.forms[0].action=url;
			document.forms[0].submit();

}
function dynamicOTbal()
{
var year=document.forms[0].year.value;

var url="leave.do?method=displayOTreq&year="+year;
			document.forms[0].action=url;
			document.forms[0].submit();
}
</script>
...
<div align="center" id="messageID" style="visibility: visible;">
		...
		<table class="bordered" width="90%">
			<tr>
				<th colspan="5" align="left"><center>My OT Request</center></th>
				<td colspan="2"  width="15%">Year <font color="red" size="4">*</font></td>
  							<td colspan="2" width="15%" align="left" colspan="" >
								<html:select name="leaveForm" property="year" styleClass="content" onchange="dynamicOTbal()">
