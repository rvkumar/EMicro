...
<script type="text/javascript">
  ...
  var url="leave.do?method=generate";
...
<html:form action="leave.do">
					
					<bean:write name="leaveForm" property="contentDescription" filter="false" />
					<logic:notEmpty name="leaveForm" property="fileFullPath">
				...
				<logic:notEmpty name="leaveForm" property="videoFullPath">
						<div style="float: right;">
									
									<bean:define id="video" name="leaveForm" property="videoFullPath" />
