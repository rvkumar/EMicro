		 ...
		 <tr><th  colspan="8" align="center">
					 Permission Form </th>
						...
						<td width="10%">Permission Date <font color="red" size="3">*</font></td> 
							...
							{%>
							<td colspan="2">
							<html:select property="type" name="permissionForm" onchange="chngeview()">							
...
<td><html:select property="swipetype" name="permissionForm"  >
			 ...
			 <tr><th  colspan="4" align="center">
					 Enter Your Reason Here<font color="red" size="2">*</font>  </th>
						...
						<tr>	
							...
							<html:textarea property="reason" cols="109" rows="9" onkeypress="return isNumber(event)" onkeyup="this.value = this.value.replace(/'/g,'`')"></html:textarea>
