...
function newFinishedProductForm(){	   
...
function deleteFinishedProduct(requestNumber)
{
...
if(agree)
{
	document.forms[0].action="finishedProduct.do?method=deleteMaterialRecord&RequestNo="+requestNumber;
document.forms[0].submit();
}
}
function onSearch(){
		
		var URL="finishedProduct.do?method=searchRecord";
		document.forms[0].action=URL;
 		document.forms[0].submit();
...
<th width="274" class="specalt" scope="row">
	...
	<td>
	<html:select property="materialCodeLists" name="finishedProductForm" >
	...
	<tr>
		...
		<html:button property="method" value="Add New" onclick="newFinishedProductForm()" ></html:button>
		</td>
	...
	<table width=100%>
		...
		<logic:notEmpty name="listOfFinishedProducts"> 
			<tr>
		<td>
		...
		Location<html:select name="finishedProductForm" property="locationSearch" styleClass="text_field">
     ...
     <display:table id="data" name="listOfFinishedProducts" requestURI="/finishedProduct.do" pagesize="10" export="true" >
            <display:column property="requestNo" title="Request Number" href="finishedProduct.do?method=editFinishedProdut" paramId="requestno" paramProperty="requestNo" sortable="true"  />
        ...
        <display:column property="locationId" title="Location Name"></display:column>
          ...
          <display:column title="Delete Record" ><html:button property="method" value="Delete" onclick="deleteFinishedProduct('${data.requestNo}')"></html:button> </display:column>
        </display:table>
