	  ...
	  if(document.forms[0].sapCodeNo.value=="")
	      ...
	      if(document.forms[0].requestedBy.value=="")
	    {
	      ...
	      return false;
			...
			var url="finishedProduct.do?method=saveSAPCrationData";
			document.forms[0].action=url;
			document.forms[0].submit();		 
}
...
<logic:notEmpty name="sapApprover">
	...
	<th colspan="2">Material Code Details:</th>
			...
			<td align="left">
				<html:text property="sapCreationDate" styleId="sapCreationDate" onfocus="popupCalender('sapCreationDate')"  styleClass="text_field"/></td>
