   ...
   if ((x=MM_findObj(a[i]))!=null){document.MM_sr[j++]=x; if(!x.oSrc) x.oSrc=x.src; x.src=a[i+2];}
	 ...
	 function popupCalender(param)
	  ...
	  function onSearch(){
		...
		var URL="semifinished.do?method=searchRecord";
...
function deleteSemiFinished(requestNumber)
{
...
if(agree)
{
	document.forms[0].action="semifinished.do?method=deleteSemiFinished&RequestNo="+requestNumber;
document.forms[0].submit();
}
}
...
<tr>
	...
	<td>
	<html:select property="materialCodeLists" name="semiFinshedForm" >
	...
	<tr>
		...
		<html:button property="method" value="Add New" onclick="newForm()" ></html:button>
		</td>
	...
	<table width=100%>
		...
		<logic:notEmpty name="listOfSemiFinished"> 
			<tr>
		<td>
		...
		Location<html:select name="semiFinshedForm" property="locationSearch" styleClass="text_field">
		...
		<html:button property="method"  value="Search" onclick="onSearch()" />
		</td>
		</tr>
		<tr>
			<td valign="top" align="left">
     <display:table id="data" name="listOfSemiFinished" requestURI="/semifinished.do" pagesize="10" export="true" >
            <display:column property="requestNo" title="Request Number" href="semifinished.do?method=editSemiFinished" paramId="requestno" paramProperty="requestNo" sortable="true"  />
        ...
        <display:column property="locationId" title="Location Name"></display:column>
          ...
          <display:column title="Delete Record" ><html:button property="method" value="Delete" onclick="deleteSemiFinished('${data.requestNo}')"></html:button> </display:column>
        </display:table>
