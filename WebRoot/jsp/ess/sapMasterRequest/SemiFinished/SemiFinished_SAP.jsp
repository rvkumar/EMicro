	  ...
	  if(document.forms[0].sapCodeNo.value=="")
	    ...
	    if(document.forms[0].requestedBy.value=="")
	    {
	      ...
	      return false;
			...
			var url="semifinished.do?method=saveSAPCrationData";
			document.forms[0].action=url;
			document.forms[0].submit();		 
}
			 ...
			 <% 
  			...
  			%>
     			...
     			<div align="center">
						...
						<font color="red">
							<bean:write name="semiFinshedForm" property="message" />
						</font>
					</logic:present>
					<logic:present name="semiFinshedForm" property="message2">
						<font color="Green">
							<bean:write name="semiFinshedForm" property="message2" />
						</font>
					</logic:present>
					</div>
...
<th colspan="4">
	...
	<html:select property="materialCodeLists" name="semiFinshedForm"   disabled="true"  style="width:550px;"   onchange="getMatrialList(this.value)" >
	...
	<html:select property="materialCodeLists1" name="semiFinshedForm"  style="width:550px;"  onchange="getMatrialList(this.value)" >
	...
	<div id="materialTable" style="visibility: visible;">
	 ...
	 <tr>
<th width="274" class="specalt" scope="row">Request No</span><span class="red_man">*</span></th>
		...
		<tr>
			...
			<tr>
				...
				<td align="left">
				<html:select name="semiFinshedForm" property="locationId" styleClass="text_field" disabled="true">
					<html:option value="">--Select--</html:option>
					<html:options name="semiFinshedForm" property="locationIdList" 
			...
			<tr>
				...
				<td align="left">
				<html:select  name="semiFinshedForm"  property="materialTypeId" styleClass="text_field" style="width:100px; " disabled="true">
					<html:option value="">--Select--</html:option>
			...
			<td>
			<html:select name="semiFinshedForm" property="storageLocationId" styleClass="text_field" style="width:250px;" disabled="true">
					<html:option value="">--Select--</html:option>
					<html:options name="semiFinshedForm" property="storageID" 
			...
			<td><html:text property="materialLongName" styleClass="text_field" style="width:400px;"  maxlength="40" readonly="true"></html:text>
			</td>
			</tr>
			<tr>
				<th width="274" class="specalt" scope="row">Material Group <img src="images/star.gif" width="8" height="8" /></th>
				<td align="left">
				<html:select name="semiFinshedForm" property="materialGroupId" styleClass="text_field" style="width:250px;" disabled="true">
					<html:option value="">--Select--</html:option>
				<html:options name="semiFinshedForm" property="materGroupIDList" 
			...
			<tr>
				...
				<td align="left">
				<html:select name="semiFinshedForm" property="unitOfMeasId" styleClass="text_field" disabled="true">
					<html:option value="">--Select--</html:option>
						<html:options name="semiFinshedForm" property="unitOfMeasIdList" 
	  ...
	  <th colspan="2">Quality Requirement:</th>
			...
			<tr><th width="274" class="specalt" scope="row">Customer Name<img src="images/star.gif" width="8" height="8" /></th>
			<td><html:text property="customerName" styleClass="text_field" style="width:400px;"  maxlength="50" readonly="true"></html:text>
				</td>
			</tr>
			<tr>
			<th width="274" class="specalt" scope="row">Prod Insp Memo<img src="images/star.gif" width="8" height="8" /></th>
			...
			<td><html:text property="shelfLife" styleClass="text_field" style="width:40px;" disabled="true"></html:text>
					<html:select property="shelfType"  styleClass="text_field"  >
				<html:option value="">-----Select-----</html:option>
			...
			<td><html:text property="batchCode" styleClass="text_field" style="width:100px;"  maxlength="10" readonly="true"></html:text>
			</td>
			</tr>
			<tr>
			<th width="274" class="specalt" scope="row">Target Weight<img src="images/star.gif" width="8" height="8" /></th>
			<td><html:text property="targetWeight" styleClass="text_field" readonly="true"></html:text>
			</td>
			</tr>
			...
			<td><html:text property="weightUOM" styleClass="text_field" maxlength="3" readonly="true"></html:text>
			</td>
			</tr>
			<tr>
			<th width="274" class="specalt" scope="row">Retest Days<img src="images/star.gif" width="8" height="8" /></th>
			<td><html:text property="retestDays" styleClass="text_field" readonly="true"></html:text>
			</td>
			</tr>
			<tr>
				<tr>
	...
	<th colspan="2">Approver Details:</th>
		...
		<tr> <th width="274" class="specalt" scope="row">Approve Type
			...
			<html:select name="semiFinshedForm" property="approveType" styleClass="text_field" disabled="true">
				<html:option value="">--Select--</html:option>
