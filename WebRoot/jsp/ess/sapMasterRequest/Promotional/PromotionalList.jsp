...
if(agree)
{
	document.forms[0].action="promotional.do?method=deleteMaterialRecord&RequestNo="+requestNumber;
document.forms[0].submit();
}
}
function onSearch(){
		
		var URL="promotional.do?method=searchRecord";
		document.forms[0].action=URL;
 		document.forms[0].submit();
...
<th colspan="4">
	...
	<td>
	<html:select property="materialCodeLists" name="promotionalForm" >
	...
	<tr>
		...
		<html:button property="method" value="Add New" onclick="newPromotionalForm()" ></html:button>
		</td>
	...
	<table width=100%>
		...
		<logic:notEmpty name="listOfPromotional"> 
			<tr>
		<td>
		...
		Location<html:select name="promotionalForm" property="locationSearch" styleClass="text_field">
     ...
     <display:table id="data" name="listOfPromotional" requestURI="/promotional.do" pagesize="10" export="true" >
            <display:column property="requestNo" title="Request Number" href="promotional.do?method=editPromotional" paramId="requestno" paramProperty="requestNo" sortable="true"  />
