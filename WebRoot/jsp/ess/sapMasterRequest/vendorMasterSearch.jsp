...
var url="vendorMasterRequest.do?method=showVendorSearchRecords";
...
{
var url="vendorMasterRequest.do?method=display";
	document.forms[0].action=url;
	document.forms[0].submit();
...
var url="vendorMasterRequest.do?method=nextCodeSearchRecords";
			document.forms[0].action=url;
			document.forms[0].submit();
...
var url="vendorMasterRequest.do?method=previousCodeSearchRecords";
			document.forms[0].action=url;
			document.forms[0].submit();
...
var url="vendorMasterRequest.do?method=lastCodeSearchRecords";
			document.forms[0].action=url;
			document.forms[0].submit();
...
<tr>
			<th colspan="6"><center>Vendor Code Search</center></th>
			</tr>
			<tr>
			<th>Name <font color="red">*</font></th></th>
					<td align="left">
				<html:text property="name1" maxlength="40"  title="Maximum of 40 characters" style="width:95%;text-transform:uppercase"></html:text>
			...
			<th>Country</th>
			<td>
		<html:select name="vendorMasterRequestForm" property="country1" style="width:95%;">
...
<div align="center">
	...
	<bean:write property="codeStartRecord"  name="vendorMasterRequestForm"/>-
	
	
	<bean:write property="codeEndRecord"  name="vendorMasterRequestForm"/>
...
<tr>
<th>Account Group</th><th>SAP Code No</th><th> Name</th><th>City</th><th>Created On</th><th>Requested On</th><th>Copy</th>
</tr>
<logic:iterate id="abc" name="materialList">
<tr>
<td><bean:write name="abc" property="accountGroupId"/></td>
...
<td><bean:write name="abc" property="requestDate"/></td>
 ...
 <logic:notEqual value="" name="abc" property="requestNumber"> 
<td><a href="#"><a href="# " title="copy" onclick="copyVendor('${abc.requestNumber}')"><img src="images/copy.png" height="28" width="28" align="absmiddle" /></a>
 </td>
 </logic:notEqual>
 <logic:equal value="" name="abc" property="requestNumber"> 
<td>&nbsp;
 </td>
 </logic:equal>
