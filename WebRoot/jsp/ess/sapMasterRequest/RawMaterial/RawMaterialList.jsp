...
function newMaterialMasterForm(){	   
...
if(agree)
{
	document.forms[0].action="rawMaterial.do?method=deleteMaterialRecord&RequestNo="+requestNumber;
document.forms[0].submit();
}
}
function onSearch(){
		
		var URL="rawMaterial.do?method=searchRecord";
		document.forms[0].action=URL;
 		document.forms[0].submit();
...
<tr>
	...
	<td>
	<html:select property="materialCodeLists" name="rawMaterialForm" >
	...
	<tr>
		...
		<html:button property="method" value="Add New" onclick="newMaterialMasterForm()" ></html:button>
		</td>
	...
	<table width=100%>
		...
		Location<html:select name="rawMaterialForm" property="locationSearch" styleClass="text_field">
     ...
     <display:table id="data" name="listOfMaterials" requestURI="/rawMaterial.do" pagesize="10" export="true" >
            <display:column property="requestNo" title="Request Number" href="rawMaterial.do?method=editMaterialRecord" paramId="requestno" paramProperty="requestNo" sortable="true"  />
