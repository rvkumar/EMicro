...
function saveData(){	   
	    ...
	    if(document.forms[0].sapCreatedBy.value=="")
	    {
	      ...
	      return false;
			...
			var url="rawMaterial.do?method=saveSAPCrationData";
			document.forms[0].action=url;
			document.forms[0].submit();		 
}
   ...
   <%
    ...
    <div class="middel-blocks">
     			<div align="center">
						...
						<font color="red">
							<bean:write name="rawMaterialForm" property="message" />
						</font>
					</logic:present>
					<logic:present name="rawMaterialForm" property="message2">
						<font color="Green">
							<bean:write name="rawMaterialForm" property="message2" />
						</font>
					</logic:present>
					</div>
	...
	<table align="center" border="0" cellpadding="4" cellspacing="0"  id="mytable1">
	 ...
	 <th width="274" class="specalt" scope="row">Request No<img src="images/star.gif" width="8" height="8" /></th>
		...
		<tr>
			...
			<th width="274" class="specalt" scope="row">Location<img src="images/star.gif" width="8" height="8" />
				...
				<td align="left">
				<html:select name="rawMaterialForm" property="locationId" styleClass="text_field"  disabled="true">
					<html:option value="">--Select--</html:option>
			...
			<td>
			<html:select  property="storageLocationId" styleClass="text_field" disabled="true" style="width:250px;">
					<html:option value="">--Select--</html:option>
			...
			<td><html:text property="materialShortName" styleClass="text_field" style="width:400px;"  readonly="true" maxlength="40"></html:text>
			</td>
			</tr>
			<tr>
			<th width="274" class="specalt" scope="row">Material Long Name<img src="images/star.gif" width="8" height="8" /></th>
			<td><html:text property="materialLongName" styleClass="text_field" style="width:580px;" readonly="true" maxlength="80"></html:text>
			</td>
			</tr>
			<tr>
				...
				<td align="left">
				<html:select name="rawMaterialForm" property="materialGroupId" styleClass="text_field" disabled="true">
					<html:option value="">--Select--</html:option>
			...
			<td><html:select property="unitOfMeasId"  styleClass="text_field" disabled="true">
				<html:option value="">-----Select-----</html:option>
			...
			<td><html:select property="puchaseGroupId"  styleClass="text_field" style="width:200px;" disabled="true">
				<html:option value="">-----Select-----</html:option>
	 ...
	 <th colspan="2">Quality Specification:</th>
			...
			<tr>
				...
				<td><html:text property="pharmacopName" styleClass="text_field"  style="width:580px;" maxlength="80" readonly="true"></html:text>
				</td>
			</tr>
			<tr>
				...
				<td align="left">
				<html:select name="rawMaterialForm" property="pharmacopGrade" styleClass="text_field" style="width:100px;" disabled="true">
					<html:option value="">--Select--</html:option>
			...
			<tr>
				...
				<td><html:text property="genericName" styleClass="text_field" style="width:580px;" maxlength="80" readonly="true"></html:text>
				</td>
			</tr>
			<tr>
				<th width="274" class="specalt" scope="row">Synonym<img src="images/star.gif" width="8" height="8" /></th>
				<td><html:text property="synonym" styleClass="text_field" style="width:580px;" maxlength="80" readonly="true"></html:text>
				</td>
			</tr>
			...
			<tr>
				...
				<td><html:text property="pharmacopSpecification" style="width:580px;" styleClass="text_field" maxlength="80" readonly="true"></html:text>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><html:select property="isDMFMaterial" styleClass="text_field" onchange="getIsDMFMaterial()" disabled="true">
				<html:option value="">-----Select-----</html:option>
				<html:option value="True">Yes</html:option>
				<html:option value="False">No</html:option>
				</html:select></td>
			...
			<tr>
				...
				<td align="left">
				<html:select name="rawMaterialForm" property="dmfGradeId" styleClass="text_field" disabled="true">
					<html:option value="">--Select--</html:option>
			...
			<tr>
				...
				<td><html:text property="materialGrade" styleClass="text_field" style="width:200px;" maxlength="30" readonly="true"></html:text>
				</td>
			</tr>
			<tr>
				...
				</th><td><html:text property="cosGradeNo" styleClass="text_field" style="width:200px;" maxlength="30" readonly="true"></html:text>
				</td>
			</tr>
			<tr>
	 ...
	 <th colspan="2">Vendor&nbsp/&nbspManufacture Information:</th>
			...
			<tr>
				...
				<td><html:select property="isVendorSpecificMaterial" styleClass="text_field"  onchange="isVendorStatus()" disabled="true">
				<html:option value="">-----Select-----</html:option>
				<html:option value="True">Yes</html:option>
				<html:option value="False">No</html:option>
				</html:select></td>
			...
			<tr>
				...
				<td><html:text property="customerName" styleClass="text_field" style="width:480px;" maxlength="50" readonly="true"></html:text>
				</td>
			</tr>
			<tr>
				<th width="274" class="specalt" scope="row">To Be Used In Product (S)<img src="images/star.gif" width="8" height="8" />
				</th><td><html:text property="toBeUsedInProducts" styleClass="text_field" style="width:580px;"  maxlength="80" readonly="true"></html:text>
				</td>
				</tr>
	<th colspan="2">Other Details:</th>
	   ...
	   <tr>
			...
			<tr>
				...
				</th><td><html:text property="shelfLife" styleClass="text_field" style="width:40px;" maxlength="4" readonly="true"> </html:text>
				<html:select property="shelfLifeType"  styleClass="text_field" style="width:100px;" disabled="true">
				<html:option value="">-----Select-----</html:option>
			...
			<tr>
				...
				<html:select property="retestType"  styleClass="text_field" style="width:100px;" disabled="true" >
				<html:option value="">-----Select-----</html:option>
				<html:option value="days">Days</html:option>
					<html:option value="months">Months</html:option></html:select>
					</td>
			...
			<td><html:select property="valuationClass"  styleClass="text_field" style="width:200px;" disabled="true">
				<html:option value="">-----Select-----</html:option>
...
<logic:notEmpty name="approved">
	...
	<tr> 
		<th width="274" class="specalt" scope="row">Approve Type
			...
			<html:select name="rawMaterialForm" property="approveType" styleClass="text_field" disabled="true">
				<html:option value="">--Select--</html:option>
