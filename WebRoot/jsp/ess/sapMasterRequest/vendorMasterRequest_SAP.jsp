...
function onSubmit(){
	...
	var url="vendorMasterRequest.do?method=saveSAPCODEData";
	document.forms[0].action=url;
	document.forms[0].submit();
}
...
<body onload="getIsEligibleTds(),getRegisteredExciseVendor()">
	...
	<tr> 
		<th width="274" class="specalt" scope="row">Approve Type
			...
			<html:select name="vendorMasterRequestForm" property="approveType" styleClass="text_field" disabled="true">
				<html:option value="">--Select--</html:option>
