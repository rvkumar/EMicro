...
<title>Package Material List</title>
...
function newPackageMaterialForm(){	   
...
function deleteMaterialRecord(requestNumber)
{
...
if(agree)
{
	document.forms[0].action="packageMaterial.do?method=deletePackageMaterial&RequestNo="+requestNumber;
document.forms[0].submit();
}
}
function onSearch(){
		
		var URL="packageMaterial.do?method=searchRecord";
		document.forms[0].action=URL;
 		document.forms[0].submit();
...
function serchRequiredData(){

		var serachtext=document.forms[0].searchData.value;
	
		if(document.forms[0].searchData.value=="")
		{
	
		}else{
			var URL="packageMaterial.do?method=serchRequiredData&search="+serachtext;
		document.forms[0].action=URL;
 		document.forms[0].submit();
...
<tr>
	...
	<td>
	<html:select property="materialCodeLists" name="PackageMaterialMasterForm" >
	...
	<tr>
		...
		<html:button property="method" value="Add New" onclick="newPackageMaterialForm()"  ></html:button>
		</td>
	...
	<table width=100%>
		...
		<logic:notEmpty name="listOfPackages"> 
		...
		Location<html:select name="PackageMaterialMasterForm" property="locationSearch" styleClass="text_field">
     ...
     <display:table id="data" name="listOfPackages" requestURI="/packageMaterial.do" pagesize="10" export="true" >
            <display:column property="requestNo" title="Request Number" href="packageMaterial.do?method=editPackageMaterialRecord" paramId="requestno" paramProperty="requestNo" sortable="true"  />
        ...
        <display:column property="locationId" title="Location Name"></display:column>
          ...
          <display:column title="Delete Record" ><html:button property="method" value="Delete" onclick="deleteMaterialRecord('${data.requestNo}')"></html:button> </display:column>
        </display:table>
