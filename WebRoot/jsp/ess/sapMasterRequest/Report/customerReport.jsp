...
function nextRecord(){
     var URL="reportRequest.do?method=nextCustomerRecord";
		document.forms[0].action=URL;
 		document.forms[0].submit();
		
}
function previousMaterialRecord(){
  var URL="reportRequest.do?method=prevCustomerRecord";
		document.forms[0].action=URL;
 		document.forms[0].submit();
}
function lastMaterialRecord(){
  var URL="reportRequest.do?method=lastCustomerRecord";
		document.forms[0].action=URL;
 		document.forms[0].submit();
}
function firstMaterialRecord(){
 var URL="reportRequest.do?method=firstCustomerRecord";
		document.forms[0].action=URL;
 		document.forms[0].submit();
...
function genrateExcel(){
	...
	document.forms[0].action="reportRequest.do?method=genrateExcelCustomerRecord";
	document.forms[0].submit();
}
function genratePdf(){

 
	document.forms[0].action="reportRequest.do?method=genratePdfCustomerRecord";
	document.forms[0].submit();
...
document.forms[0].action="reportRequest.do?method=genrateCsvCustomerRecord";
	document.forms[0].submit();
}
function datarange(){
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <div align="center">
	 ...
	 <table>
	 <th colspan='2'>Customer Report</th>
	...
	<logic:notEmpty name="customerList">
		...
		<tr>
         ...
         <display:table id="mytable1" name="customerList" requestURI="/reportRequest.do" pagesize="10" export="false">
     	
       <display:column property="c_requestDate" title="Request Date"></display:column>
        <display:column property="c_name" title="Customer Name"></display:column> 
        <display:column property="c_location" title="Location Name"></display:column> 
        <display:column property="c_country" title="Country Name"></display:column>
        <display:column property="c_customerGroup" title="Customer Group"></display:column> 
         <display:column property="c_status" title="Approval Status"></display:column> 
           
           
             <display:column property="c_requestedBy" title="Requested By"></display:column>
