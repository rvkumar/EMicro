...
function nextRecord(){
     var URL="reportRequest.do?method=nextServiceRecord";
		document.forms[0].action=URL;
 		document.forms[0].submit();
		
}
function previousMaterialRecord(){
  var URL="reportRequest.do?method=prevServiceRecord";
		document.forms[0].action=URL;
 		document.forms[0].submit();
}
function lastMaterialRecord(){
  var URL="reportRequest.do?method=lastServiceRecord";
		document.forms[0].action=URL;
 		document.forms[0].submit();
}
function firstMaterialRecord(){
 var URL="reportRequest.do?method=firstServiceRecord";
		document.forms[0].action=URL;
 		document.forms[0].submit();
...
function genrateExcel(){
	...
	document.forms[0].action="reportRequest.do?method=genrateExcelServiceRecord";
	document.forms[0].submit();
}
function genratePdf(){
document.forms[0].action="reportRequest.do?method=genratePdfServiceRecord";
	document.forms[0].submit();


}
function genrateCsv(){
document.forms[0].action="reportRequest.do?method=genrateCsvServiceRecord";
	document.forms[0].submit();
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <div align="center">
	 ...
	 <table>
	 <th colspan='2'>Service Report</th>
	...
	<logic:notEmpty name="serviceList">
		...
		<tr>
         ...
         <display:table id="mytable1" name="serviceList" requestURI="/reportRequest.do" pagesize="10" export="false">
     	
        <display:column property="s_requestDate" title="Request Date" ></display:column>
        <display:column property="s_serviceCatagory" title="Service Catagory"></display:column>
        <display:column property="s_serviceDescription" title="Service Description"></display:column> 
         <display:column property="s_serviceGroup" title="Service Group"></display:column> 
           <display:column property="s_plant" title="Plant Code"></display:column> 
            <display:column property="s_status" title="Approve Status"></display:column> 
             <display:column property="s_requestedBy" title="Requested By"></display:column> 
             <display:column property="s_approveDate" title="Approve Date"></display:column>
