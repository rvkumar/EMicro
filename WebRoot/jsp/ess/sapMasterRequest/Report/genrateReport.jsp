...
function nextRecord(){
     var URL="reportRequest.do?method=nextRecord";
		document.forms[0].action=URL;
 		document.forms[0].submit();
		
}
function previousMaterialRecord(){
  var URL="reportRequest.do?method=prevRecord";
		document.forms[0].action=URL;
 		document.forms[0].submit();
}
function lastMaterialRecord(){
  var URL="reportRequest.do?method=lastRecord";
		document.forms[0].action=URL;
 		document.forms[0].submit();
}
function firstMaterialRecord(){
 var URL="reportRequest.do?method=firstRecord";
		document.forms[0].action=URL;
 		document.forms[0].submit();
...
function genrateReport(){
	...
	document.forms[0].action="reportRequest.do?method=showSearchBar";
	document.forms[0].submit();
}
function genrateExcel(){
	...
	document.forms[0].action="reportRequest.do?method=genrateExcelMasterRecord";
	document.forms[0].submit();
}
function genratePdf(){

 
	document.forms[0].action="reportRequest.do?method=genratePdfMasterRecord";
	document.forms[0].submit();
...
document.forms[0].action="reportRequest.do?method=genrateCsvMasterRecord";
	document.forms[0].submit();
}
function datarange(){
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <div align="center">
	 ...
	 <table>
	 <th colspan='2'>Material Report</th>
	...
	<logic:notEmpty name="reportList">
		...
		<tr>
         ...
         <display:table id="mytable1" name="reportList" requestURI="/reportRequest.do"  export="false">
     	
        <display:column property="m_rquestDate" title="Request Date" ></display:column>
        <display:column property="m_status" title="Approve Status"></display:column>
        <display:column property="m_materialType" title="Material Type"></display:column> 
         <display:column property="m_approveDate" title="Approve Date"></display:column> 
           <display:column property="m_plant" title="Plant Code"></display:column> 
            <display:column property="m_materialGroup" title="Material Group"></display:column> 
             <display:column property="m_requestedBy" title="Requested By"></display:column> 
    ...
    <html:hidden name="reportRequestForm" property="m_status"></html:hidden>
	<html:hidden name="reportRequestForm" property="m_materialType"></html:hidden>
	<html:hidden name="reportRequestForm" property="m_rquestDate" ></html:hidden>
	<html:hidden name="reportRequestForm" property="m_requestedBy"></html:hidden>
