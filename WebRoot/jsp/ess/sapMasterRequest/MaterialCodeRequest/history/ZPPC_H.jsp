...
<logic:notEmpty name="zppcdetails">
<logic:iterate id="m" name="zppcdetails">
<table class="bordered">
<tr><th colspan="3"><center>ZPPC-Promotional Material</center></th>
</tr>
<tr>
...
<tr><td>Request No</td><td>${m.requestNumber }</td><td>${m.requestNumber }</td></tr>
	...
	<tr><td>Divison</td><td>${m.divisionId }</td><td>${m.divisionId_C }</td></tr>
<tr>
<th colspan="3">Other Details</th>
</tr>
<tr><td>Is Asset</td><td>${m.isAsset }</td><td>${m.isAsset_C }</td></tr>	
<tr><td>Purpose </td><td>${m.purposeID }</td><td>${m.purposeID_C }</td></tr>	
<tr><td>Is SAS Form Available </td><td>${m.isSASFormAvailable }</td><td>${m.isSASFormAvailable_C }</td></tr>	
