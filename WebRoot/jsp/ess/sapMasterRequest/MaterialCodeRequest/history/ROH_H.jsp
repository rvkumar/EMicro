...
<logic:notEmpty name="ROH">
<logic:iterate id="m" name="ROH">
<table class="bordered">
<tr><th colspan="3"><center>ROH-Raw Material</center></th>
</tr>
<tr>
...
<tr>
<th colspan="3">Quality Specification</th>
</tr>
<tr><td>Pharmacopoeial Name </td><td>${m.pharmacopName }</td><td>${m.pharmacopName_C }</td></tr>
<tr><td>Pharmacopoeial Grade</td><td>${m.pharmacopGrade }</td><td>${m.pharmacopGrade_C }</td></tr>
<tr><td>Generic Name</td><td>${m.genericName }</td><td>${m.genericName_C }</td></tr>
<tr><td>Synonym</td><td>${m.synonym }</td><td>${m.synonym_C }</td></tr>
<tr><td>Pharmacopoeial Specification</td><td>${m.pharmacopSpecification }</td><td>${m.pharmacopSpecification_C }</td></tr>
...
<tr><td>Material Grade </td><td>${m.materialGrade }</td><td>${m.materialGrade_C }</td></tr>
