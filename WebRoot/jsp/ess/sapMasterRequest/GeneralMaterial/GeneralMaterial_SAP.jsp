...
function saveData(){	
	    ...
	    if(document.forms[0].requestedBy.value=="")
	    {
	      ...
	      return false;
			...
			var url="generalMaterial.do?method=saveSAPCrationData";
			document.forms[0].action=url;
			document.forms[0].submit();		 
}
			 ...
			 <% 
  			...
  			%>
     			...
     			<div align="center">
						...
						<font color="red">
							<bean:write name="generalMaterialForm" property="message" />
						</font>
					</logic:present>
					<logic:present name="generalMaterialForm" property="message2">
						<font color="Green">
							<bean:write name="generalMaterialForm" property="message2" />
						</font>
					</logic:present>
					</div>
...
<html:button property="method" value="New" onclick="moveMaterialCode()"></html:button></th>
	...
	<table align="center" border="0" cellpadding="4" cellspacing="0"  id="mytable1" style="width:800px;">
...
<th colspan="4">
	...
	<th width="180" class="specalt" scope="row">
	Material&nbspType
</th>
	<td>
	<div id="t1" style="visibility: visible;height: 20px;">
	<html:select property="materialCodeLists" name="generalMaterialForm"   disabled="true"  style="width:550px;">
	...
	<html:select property="materialCodeLists1" name="generalMaterialForm"  style="width:550px;"  onchange="getMatrialList(this.value)" >
   ...
   <tr>
	 ...
	 <th width="274" class="specalt" scope="row">Request No<img src="images/star.gif" width="8" height="8" /></th>
		...
		<tr>
			...
			<tr>
				...
				<td align="left">
				<html:select name="generalMaterialForm" property="locationId" styleClass="text_field" disabled="true">
					<html:option value="">--Select--</html:option>
			...
			<html:select  property="storageLocationId" styleClass="text_field" disabled="true">
					<html:option value="">--Select--</html:option>
					<html:options name="generalMaterialForm" property="storageID" 
			...
			<td><html:text property="materialShortName" styleClass="text_field" style="width:380px;"  maxlength="40" readonly="true" ></html:text>
			</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="left">
				<html:select name="generalMaterialForm" property="materialGroupId" styleClass="text_field" disabled="true">
					<html:option value="">--Select--</html:option>
					<html:options name="generalMaterialForm" property="materGroupIDList" 
									labelProperty="materialGroupIdValueList"/></html:select>
				<br /></td>
			</tr>
			<tr>
				<th width="274" class="specalt" scope="row">Purchase Group<img src="images/star.gif" width="8" height="8" /></th>
				<td>
				<html:select property="puchaseGroupId" styleClass="text_field" >
				<html:option value="">-----Select-----</html:option>
			...
			<tr>
				...
				<html:option value="">-----Select-----</html:option>
				<html:options name="generalMaterialForm" property="unitOfMeasIdList" 
	...
	<th colspan="4">Other Details :</th>
			...
			<tr>
				...
				<td>
				<html:select property="materialUsedIn" styleClass="text_field" disabled="true">
				<html:option value="">-----Select-----</html:option>
				<html:option value="1">1</html:option>
				<html:option value="2">2</html:option>
				</html:select>
			...
			<tr>
				...
				<td><html:select property="isEquipment" styleClass="text_field" disabled="true">
					<html:option value="">-----Select-----</html:option>
			...
			<tr>
				...
				<td><html:select property="isSpare" styleClass="text_field" disabled="true">
					<html:option value="">-----Select-----</html:option>
					<html:option value="True">Yes</html:option>
					<html:option value="False">No</html:option>
				</html:select></td>
			...
			<tr>
				...
				<td><html:select property="isNew" styleClass="text_field" disabled="true">
					<html:option value="">-----Select-----</html:option>
					<html:option value="True">Yes</html:option>
					<html:option value="False">No</html:option>
				</html:select></td>
			...
			<td><html:text property="equipmentName" styleClass="text_field" style="width:580px;"  maxlength="80" readonly="true"></html:text>
			</td>
			</tr>
			<tr>
			<th width="274" class="specalt" scope="row">PR Number<img src="images/star.gif" width="8" height="8" /></th>
			<td><html:text property="prNumber" styleClass="text_field"   maxlength="12" readonly="true"></html:text>
			</td>
			</tr>
				<tr>
			<th width="274" class="specalt" scope="row">PO Number<img src="images/star.gif" width="8" height="8" /></th>
			<td><html:text property="poNumber" styleClass="text_field"   maxlength="12" readonly="true"></html:text>
			</td>
			</tr>
			<tr>
			<th width="274" class="specalt" scope="row">Utilizing Dept<img src="images/star.gif" width="8" height="8" /></th>
			<td><html:text property="utilizingDept" styleClass="text_field" style="width:300px;"  maxlength="40" readonly="true"></html:text>
			</td>
			</tr>
			<tr>
			...
			<tr>
			<th width="274" class="specalt" scope="row">Detailed Justification<img src="images/star.gif" width="8" height="8" /></th>
			<td><html:textarea property="detailedJustification" cols="40" rows="10" style="background-color:#f6f6f6;border:#38abff 1px solid;" readonly="true"></html:textarea>
			</td>
			</tr>
			<tr>
			<th width="274" class="specalt" scope="row">Detailed Specification<img src="images/star.gif" width="8" height="8" /></th>
			<td><html:textarea property="detailedSpecification" cols="40" rows="10" style="background-color:#f6f6f6;border:#38abff 1px solid;" readonly="true"></html:textarea>
			</td>
			</tr>
	...
	<th colspan="2">Approver Details:</th>
		...
		<tr> <th width="274" class="specalt" scope="row">Approve Type
			...
			<html:select name="generalMaterialForm" property="approveType" styleClass="text_field">
				<html:option value="">--Select--</html:option>
