...
<script type="text/javascript">
	...
	var traveldesk=document.getElementById("travel_desk_type1").value;
	...
	if(traveldesk!=""){
		...
		xmlhttp.open("POST","travelrequest.do?method=displayApprovers&traveldesk="+traveldesk,true);
		xmlhttp.send();
	}
}
...
var str1=$("#popupDatepicker").val();
	var str2=$("#popupDatepicker2").val(); 
	...
	$('#date1').datepicker('option', { minDate: new Date(str1),
...
function applyDomastic(){
	...
	if(document.forms[0].purposetext.value=="")
	{
	
	alert("Please enter Purpose of Travel ");
	document.forms[0].purposetext.focus();
	$('#open2').click();
	return false;
	...
	if(document.forms[0].travelRequestFor.value!="One Way")
{
	...
	var j=document.getElementById("the_iframe").contentDocument.value;
...
if(document.forms[0].toPlace.value=="")
	...
	if(document.getElementById("travel_desk_type1").value=="")
	{
	
	alert("Please select the travel desk");
	document.getElementById("travel_desk_type1").focus();
	$('#open2').click();
	return false;
...
var table = document.getElementById('mcityplan');
    ...
    $('#traveltype21').val("");
     ...
     cell6.innerHTML=$('#traveldesk21').val();
    var element1= document.createElement("input");
    element1.type="hidden";
    element1.value=$('#traveldesk21').val();
    element1.name="mtraveldesk1";
    cell6.appendChild(element1);
    $('#traveldesk21').val("");
    
    cell7.innerHTML=$('#remarks1').val();
    var element1= document.createElement("input");
    element1.type="hidden";
    ...
    cell8.innerHTML="<img src='images/delete.png' onclick='deleteRow2(this,1)' title='Delete32'/>"; 
...
var table = document.getElementById('mcity');
  ...
  /*   var cell22 = row.insertCell(21);
    ...
    cell2.innerHTML=$('#morigin').val();
    var element1= document.createElement("input");
    element1.type="hidden";
    element1.value=$('#morigin').val();
    element1.name="morigin";
    cell2.appendChild(element1);
    $('#morigin').val("");
    
    
    cell3.innerHTML=$('#mdeparture').val();
    
    var element1= document.createElement("input");
    element1.type="hidden";
    element1.value=$('#mdeparture').val();
    element1.name="mdeparture";
    cell3.appendChild(element1);
    $('#mdeparture').val("");
...
/*     cell5.innerHTML=$('#marrtime').val();
  ...
  /*   cell7.innerHTML=$('#mhotel_Res').val();  */
    var element1= document.createElement("input");
    ...
    cell21.innerHTML="<img src='images/delete.png' onclick='deleteRow1(this,1)' title='Delete'/>";
...
/*   document.getElementById("timeTo").style.backgroundColor = ""; */
  ...
  if(document.forms[0].travelRequestFor.value!="Multi-City1")
 {
 document.getElementById("travelmodemain").disabled=false;
 document.getElementById("traveltype").disabled=false;
 document.getElementById("travel_desk_type").disabled=false;
 document.getElementById("service_class").disabled=false;
  document.getElementById("travel_desk_type1").style.backgroundColor = "grey"; 
  document.getElementById("travel_desk_type1").disabled=true;
    document.getElementById("travelmodemain").style.backgroundColor = "";
    document.getElementById("travel_desk_type").style.backgroundColor = "";
      document.getElementById("travel_desk_type1").style.backgroundColor = "grey";
        document.getElementById("traveltype").style.backgroundColor = "";
          document.getElementById("travel_desk_type").style.backgroundColor = "";
            document.getElementById("service_class").style.backgroundColor = "";
            document.getElementById("travelID").style.display = "";
 ...
 {
 document.getElementById("popupDatepicker2").disabled=false;
 document.getElementById("travelmodemain").disabled=true;
 document.getElementById("traveltype").disabled=true;
 document.getElementById("travel_desk_type").disabled=true;
 document.getElementById("service_class").disabled=true;
  document.getElementById("travel_desk_type1").disabled=false;
  document.getElementById("travel_desk_type1").style.backgroundColor = "";
  document.getElementById("travelmodemain").style.backgroundColor = "grey";
  document.getElementById("traveltype").style.backgroundColor = "grey";
  document.getElementById("service_class").style.backgroundColor = "grey";
  document.getElementById("travel_desk_type").style.backgroundColor = "grey";
   document.getElementById("travelID").style.display = "none";
   /*var travel =document.getElementById("travelFor").value;
   if(travel="Self")
   {
	   document.getElementById("travelFor").value="Self";
   }
   if(travel="On Behalf")
   {
	   document.getElementById("travelFor").value="On Behalf";
   }
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("traveldesk21").innerHTML=xmlhttp.responseText;
    }
  }
xmlhttp.open("POST","travelrequest.do?method=travelDesk2&type="+dt,true);
xmlhttp.send();
}
}
...
/*  $(function() {
$('#date1').datepick({dateFormat: 'dd/mm/yyyy',minDate:start,maxDate:end,autoclose: true});
	$('#inlineDatepicker').datepick({onSelect: showDate,autoclose: true});});  */
/* var start=$("#popupDatepicker").val();
		...
		<div id="masterdiv" class="">
			...
			<div id="R1" class="tabcontent" style="width: 1000px; margin-left: 22px" >
				...
				<table class="bordered" style="position: relative;left: 2%;width: 90%;">
					...
					<tr style="display:none" id="travelID">
						...
						<td>
					 	...
					 	<%--  <html:select  property="travel_desk_type"  styleId="travel_desk_type"  onchange="displayApprovers()">
						<html:option value="">--Select--</html:option>
						<html:options name="travelRequestForm"  labelProperty="traveldeskname"/>
						</html:select>	  --%>
...
<tr>
					...
					<td colspan="3">
					 ...
					 <td>Travel Desk: <font color="red" size="3">*</font></td>
						<td>
							<!-- <select name="travel_desk_type" id="travel_desk_type1" onchange="displayApprovers()">
								<option value="">--Select</option>
								<option value="PRADEEP">PRADEEP</option>
								<option value="ARUN PRASAD">ARUN PRASAD</option>
								<option value="KUMAR K V">KUMAR K V </option>
								
							</select> -->
							
							<html:select  property="travel_desk_type"  name="travelRequestForm" styleId="travel_desk_type1"  onchange="displayApprovers()" disabled="true">
						<html:option value="">--Select--</html:option>
						<html:options name="travelRequestForm"  property="traveldeskList" labelProperty="traveldeskLabelList"/>
				</html:select>						
						</td>
					<%-- <td 
				...
				<tr>
					...
					<html:select name="travelRequestForm" property="travelFor" styleClass="text_field" style="width:80px;" onchange="tabchange()"  styleId="travelFor">
						<html:option value="Self" >Self</html:option>
				<html:option styleId="s1" value="On Behalf" >On Behalf</html:option>
						<html:option styleId="s2" value="Guest" >Guest</html:option>
						<html:option styleId="s3" value="Multiple" >Multiple</html:option>
						</html:select>
					
					</td> 
				 <%--  <td id="traveller2" style="display: none" colspan="2"
				
					title=" SELF: Only you are travelling&#013; ON BEHALF: Booking for another employee&#013; GUEST: Booking for external persons like doctors, customers etc.,&#013; MULTIPLE: Booking for employee and external persons&#013;">
					Travel For: <font color="red" size="3">*</font> &nbsp;
					
					<html:select name="travelRequestForm" property="travelFor" styleClass="text_field" style="width:80px;">
						<html:option value="Self" >Self</html:option>
						<html:option value="On Behalf" >On Behalf</html:option>
						<html:option value="Guest" >Guest</html:option>
						<html:option value="Multiple" >Multiple</html:option>
			 ...
			 --%>	</tr>	
		        <tr id="destDisplay" >
					...
					<td><html:text property="returnOn"  styleId="popupDatepicker2" readonly="true" onchange="updatedate(),checkingdates()" onmouseover="updatedate(),checkingdates()"  onclick="updatedate(),checkingdates()"  onblur="updatedate(),checkingdates()"/></td>
				<%-- <td>Preferred Time: <font color="red" size="3">*</font></td>
				 ...
				 --%>	
					<%--  <td colspan="2" title=" ADULT: +12 yrs&#013; CHILDREN: 2-12 yrs&#013; INFANT: 0-2 yrs&#013;">No of Travellers:
		...
		<div id="R4" class="tabcontent" style="width: 1000px; margin-left: 22px" >
			...
			<table class="bordered" style="position: relative;left: 2%;width: 90%;" id="mcity">
				<tr><th colspan="6">Multiple City List </th></tr>
				<tr>
					<th>Travel list</th><th>Origin</th><th>Departure Date</th><th> Destination</th><th>Arrival date</th> 
				...
				<td>${abc.origin}<input name="morigin" value="${abc.origin}" type="hidden"></td>
			<td>${abc.trip_From_Date}<input name="marrvdatel" value="${abc.trip_From_Date}" type="hidden"></td>
				<td>${abc.departure}<input name="mdeparture" value="${abc.departure}" type="hidden"></td>
			
			 	
			 	<%--<td>${abc.trip_To_time}<input name="marrtimel" value="${abc.trip_To_time}" type="hidden"> 
				</td>--%>
				<td>${abc.trip_To_Date}<input name="mdeptdatel" value="${abc.trip_To_Date}" type="hidden"></td>
			<%-- 	<td>${abc.trip_To_time}<input name="mdepttimel" value="${abc.trip_To_time}" type="hidden"> 
				</td>--%>
				
				<td style="display: none;"><input name="mhotel_Resl" value="${abc.hotel_Res}" type="hidden"></td>
			...
			<table class="bordered" style="position: relative;left: 2%;width: 90%;">
				...
				<tr> 
					<td >Origin:<font color="red" size="3">*</font> </td>
					<td colspan="2"><input type="text" name="morigin" id="morigin"/> </td>
					<td >Departure Date:<font color="red" size="3">*</font> </td>
					<td colspan="2"><input type="text" name="mdeptdate" id="mdeptdate" onclick="datedisplay(this.id)" onmouseover="datedisplay(this.id)"/> </td>
			<%-- 		<td>Departure Time:<font color="red" size="3">*</font> </td>
				...
				<tr>
					<td>Destination: <font color="red" size="3">*</font></td>
					<td colspan="2"><input type="text" name="mdeparture" id="mdeparture"/> </td>
					<td>Arrival date: <font color="red" size="3">*</font></td>
					<td colspan="2"><input type="text" name="marrvdate" id="marrvdate"  onclick="datedisplay(this.id)" onmouseover="datedisplay(this.id)"/> </td>
			...
			<table class="bordered" style="position: relative;left: 2%;width: 90%;" id="mcityplan">
				<tr><th colspan="8">Multiple Travel Plan </th></tr>
				<tr>
					<th>Date</th><th>Origin</th><th> Destination</th><th>Travel Type</th> 
					<th>Travel mode</th><th>Travel desk</th><th>Remarks</th><th>Action</th>
				</tr>
			...
			<table class="bordered" style="position: relative;left: 2%;width: 90%;">
				...
				<tr>
					...
					<input type="text" id="date1"     name="mdeptdate1" style="width: 80px;" onclick="datedisplay1(this.id)" onmouseover="datedisplay1(this.id)" onkeyup="this.value = this.value.replace(/'/g,'`')" readonly="true"/></td>
...
<!-- 					<input type="text" name="mdeptdate1" id="date1" onclick="datedisplay1(this.id)" onmouseover="datedisplay1(this.id)"/></td> -->
					...
					<select name="travelmode21"  onchange="travelmode6(),travelmode61()"  id="travelmode21" >
							<option value="">--Select--</option>
							<option value="Road">Road</option>
							<option value="Rail">Rail</option>
							<option value="Air">Air</option>
					...
					<td> Travel Desk<font color="red" size="3">*</font> 
					<select name="traveldesk21" id="traveldesk21"  onchange="passdisplay1()" >
							<option value="">--Select</option>
						</select>
					</td>
			...
			<logic:notEmpty name="Revert"></logic:notEmpty>
    ...
    <tr>
    <th colspan="5"><center>History Status</center></th>
    </tr>
    <tr><th>Employee Name</th><th>Designation</th><th>Status</th><th>Date</th><th>Comments</th></tr> 
   	<logic:iterate id="abc" name="userdetails">
	<tr>
	<td>${abc.approver }</td>
