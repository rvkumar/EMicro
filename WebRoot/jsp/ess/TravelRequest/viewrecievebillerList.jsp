...
function submitdata(status)
{
	...
	document.forms[0].action="travelrequest.do?method=updateFinanceDetails&status="+status;
	document.forms[0].submit();
...
<% int i =0; %>
			...
			<br/>
				...
				<html:button property="method" styleClass="rounded" value="Recieved" onclick="submitdata('Received')" style="align:right;width:100px;"/>
