...
.overlay{
  ...
  <br/>
	...
	<html:button property="method" styleClass="rounded" value="Search" onclick="searchrequest()" style="align:right;width:100px;"/>
  	...
  	<tr><th colspan="14"><center> Travel Booking List</center></th></tr>
  	...
  	<td>
<a  href="travelrequest.do?method=ViewBookingrequest&requstNo=<bean:write name="a" property="requestNumber"/>&requststatus=<bean:write name="a" property="reqStatus"/>" ><img src="images/view.gif" width="28" height="28"/></a>
	</td></tr>
