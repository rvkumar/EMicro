...
function submitdata(status)
{
	...
	{
	alert("Please Enter Commnets");
	return false;
	}
	
	document.forms[0].action="travelrequest.do?method=updateFinanceveirfyDetails&status="+status;
	document.forms[0].submit();
...
<div align="center" id="messageID" style="visibility: true;">
		...
		<td>${travelRequestForm.travelagentname}</td>
		</tr>
		<tr>
		<th>Submitted Date</th>
		<td>${travelRequestForm.billdate}</td>
		<th>Amount</th>
		<td>${travelRequestForm.billamount}</td>
		</tr>
...
<% int i =0; %>
				<table class="bordered" style="position: relative;left: 2%;width: 80%;">
						...
						<tr>
						<td>
						<a href="travelrequest.do?method=ViewMyrequest&requstNo=<bean:write name="abc" property="requestNumber"/>" title="View">${abc.requestNumber}</a>
			...
			<tr>
			<td>
			<label><b>Commments</b></label><font color="red" size="3">*</font>
			<textarea rows=""    name="comments"  cols="60"></textarea>   </td>
			</tr>
			</table>
			<br/>
				<div style="margin-left: 220px">
			
				<html:button property="method" styleClass="rounded" value="Verify" onclick="submitdata('Received')" style="align:right;width:100px;"/>
				<html:button property="method" styleClass="rounded" value="Rejected" onclick="submitdata('Rejected')" style="align:right;width:100px;"/>
