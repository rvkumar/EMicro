...
if(document.forms[0].traveltype.value=="International")
	...
	document.forms[0].action="travelrequest.do?method=updateDomestic";
	document.forms[0].submit();
                  return true;
               }
               else{
		...
		<table class="bordered" style="position: relative;left: 2%;width: 85%;">
			<tr>
				<td colspan="6" align="center">
					<center>
						<html:button property="method" styleClass="rounded" value="Update" onclick="updateDomestic()" style="align:right;width:100px;"/> &nbsp;
