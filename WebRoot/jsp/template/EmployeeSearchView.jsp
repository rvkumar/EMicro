...
var url="contacts.do?method=curentRecord2";
			document.forms[0].action=url;
			document.forms[0].submit();
			...
			<tr>
				...
				<th colspan="4" style="text-align:center;" >OFFICIAL INFORMATION </th>
					...
					<tr>
						...
						<tr>
                             <th align="left">Grade </th><td >${detailsView.gradeID}</td> 
                           	<th align="left">State </th><td >${detailsView.state}</td> 
                        
						</tr>
						<tr style="height:10px;">
								<th align="left">Location</th><td>${contactsForm.place}</td>
		...
		<logic:present name="employeeOfficialInfoForm" property="message">
			...
			<tr>
				<td colspan="4" style="text-align: center;">
					<html:button property="method"  value="Close" onclick="closeemp()" styleClass="rounded" style="width: 100px"></html:button>
