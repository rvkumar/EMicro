...
<body>
	<table width="100%" >
   		<tr>
    		...
    		<html:form action="hr.do" enctype="multipart/form-data">
    			<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
    				<tr>
          				<td align="left"><bean:write name="hrForm" property="contentDescription" filter="false" /></td>
          			</tr>
          			<tr>
          				<td>
          				<logic:notEmpty name="hrForm" property="fileFullPath">
          				...
          				<bean:define id="file" name="hrForm" property="fileFullPath" />
								<%
									...
									%>
									<a href="<%=v[i]%>" target="_blank"><%=u%></a><br/>
									<%
									}
									%>
          				</td>
									...
									<bean:define id="video" name="hrForm" property="videoFullPath" />
									<logic:notEmpty name="hrForm" property="videoFullPath">
...
String getImages="select * from archieves where link_name='"+linkName+"' and module='Main' and status='null' order by month desc";
System.out.println("getImages="+getImages);
ResultSet rsImages=ad.selectQuery(getImages);
String imagepath="";
while(rsImages.next()) {

	imagepath=imagepath+rsImages.getString("image_name")+",";
...
%>
  ...
  if(imagepath.equalsIgnoreCase("")||imagepath.equalsIgnoreCase(","))
		  {
