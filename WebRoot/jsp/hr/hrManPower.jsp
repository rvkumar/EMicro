...
function addNewDepart(){
	var url="hrManPower.do?method=newManPowerMatrixForm&sId=ManPower Matrix&id=HR";
...
function showManPower(){
	...
	var url="hrManPower.do?method=displayManPower&sId=Manpower Matrix&id=HR";
	document.forms[0].action=url;
	document.forms[0].submit();
}
	...
	<div id="wraper">   
    	...
    	<div style="padding-left: 10px;width: 100%;" class="content_middle"><!--------CONTENT MIDDLE STARTS -------------------->
        	...
        	<div>
				...
				<html:form action="/hrManPower.do" enctype="multipart/form-data">
				<%
				...
				<table id="mytable1"> 								
					<tr>
						...
						<td align="right" style="border:0px;"><input id="newDepart" class="sudmit_btn" style="height:20px;" value="New Department" onmousedown="addNewDepart();" /></td>
                   	</tr>
                   	<tr></tr>
                   	<tr>
						...
						<td style="text-align:center; display:none; width:300px;border:0px;" id="successful"><bean:write name="hrManPowerMatrixForm" property="message"/></td>
                   	</tr>
				</table>
				<br/>
				<br/>
					...
					<table border="1" class="forumline" align="center" id="mytable1">
						...
						<tr>
							...
							<td style="color:#127BCA;"><bean:write name="abc" property="department" /></td>
							<td><bean:write name="abc" property="jobTitle" /></td>
							<td><a href="<bean:write name="abc" property="recLink"/>"><bean:write name="abc" property="reqEmp" /></a></td>	
						</tr>
