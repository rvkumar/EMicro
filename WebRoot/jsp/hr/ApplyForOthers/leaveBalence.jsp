...
<logic:notEmpty name="LeaveBalenceList">
		...
		<table class="bordered" width="90%">
			<tr>
				<th colspan="5" align="left">Leave Balances (In Days)-<bean:write name="hrLeaveForm" property="year"/></th>
			</tr>
		<tr>
			<th>Leave Type</th><th>Opening Balance</th><th>Availed</th><th>Closing Balance</th><th>Leaves Awaiting for Approval</th>
			</tr>
			<tr>
			<td colspan="5"><center><font color="Green"><bean:write name="hrLeaveForm" property="message2" /></font></center> </td>
			</tr>
			</table>
