...
return false;
  ...
  var url="hrLeave.do?method=submitnewcomp&param="+param;
					document.forms[0].action=url;
					document.forms[0].submit();
...
<td><a href="#" ><img src="images/delete.png"   onclick="deleteRow()" title="Remove Row"/></a></td>
	...
	<tr><td>${hrLeaveForm.employeeNumber}</td><td>${hrLeaveForm.employeeName}</td><td>${hrLeaveForm.designation}</td></tr>
