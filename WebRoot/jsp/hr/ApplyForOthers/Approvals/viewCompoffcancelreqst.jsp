...
document.forms[0].action="hrApprove.do?method=cancelCompffRequest&ReqNo="+id+"&ReqType="+type+"&status="+status;
	...
	<html:hidden property="employeeNo"/>
		...
		<%-- 	<td width="15%">To Date <font color="red" size="3">*</font></td>
						...
						<td width="15%">Comp Off Type <font color="red" size="3">*</font></td> 
							...
							<td align="left" width="34%">
							<bean:write name="hrApprovalForm" property="reasonType"/>
							</td>	
			</tr>
					<tr>
       ...
       <td><bean:write name="a" property="shift"/></td> 
				...
				<tr><th colspan="6">User Remarks </th>
					...
					<tr>
						...
						<td colspan="4" ><center>
				<logic:notEqual value="2" property="status" name="hrApprovalForm"><logic:notEmpty name="cancelbutton"><html:button property="method" value="Cancel Comp-Off" styleClass="rounded" style="width: 100px" onclick="changeStatus('${hrApprovalForm.id}','Comp-Off',this.value)"/>
				<html:button property="method" value="Reject" styleClass="rounded" style="width: 100px" onclick="changeStatus('${hrApprovalForm.id}','Comp-Off',this.value)"/>
