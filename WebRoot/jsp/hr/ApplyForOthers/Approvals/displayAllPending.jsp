...
function disableSearch(reqFieldName){
  ...
  <div align="center">
				...
				<logic:present name="hrApprovalForm" property="message2">
					<font color="red" size="3"><b><bean:write name="hrApprovalForm" property="message2" /></b></font>
				</logic:present>
			</div>
...
<th><b>Request Type : <font color="red">*</font></b>
	...
	<th><b>Filter by</b> <font color="red">*</font></th>
						...
						<th>Employee No.</th>
      		<td colspan="8"> 
      			<html:text property="employeeNo"  styleClass="text_field" title="Enter Employee No." onkeyup="searchEmployee('employeeNo')" styleId="employeeNo">
	...
	<div id="sU" style="display:none;">
		...
		<a href="#"><img src="images/search.png" align="absmiddle"   onclick="showSelectedFilter()"/></a>
...
<br/>
		...
		<table class="bordered sortable">
			<tr>
		<logic:equal value="Pending" property="selectedFilter" name="hrApprovalForm"><th>Select</th>	</logic:equal><th>Req&nbsp;No</th><th style="width:200px;">Employee Name</th><th>Requested On</th>
...
<logic:equal value="Pending" property="selectedFilter" name="hrApprovalForm"><td><html:checkbox property="selectedRequestNo" name="hrApprovalForm" value="${leave.requestNumber}"/></td></logic:equal>
...
<br/>
		...
		<table class="bordered sortable">
			<tr>
				<logic:equal value="Pending" property="selectedFilter" name="hrApprovalForm"><th>Select</th>	</logic:equal><th>Req&nbsp;No</th><th style="width:100px;">Leave Type</th><th style="width:200px;">Employee Name</th><th>Requested On</th>
...
<%-- <logic:equal value="Approved" property="selectedFilter" name="hrApprovalForm"><td><a  href="hrApprove.do?method=selectRequest&requstNo=<bean:write name="leave" property="requestNumber"/>" ><img src="images/view.gif" width="28" height="28"/></a></td></logic:equal>
 --%>
</tr>
...
<tr>
<td><html:checkbox property="selectedRequestNo" name="hrApprovalForm"  value="${onDuty.requestNumber}"/></td>
...
<th>Select</th>	<th>Req&nbsp;No</th><th style="width:100px;"> Type</th><th style="width:200px;">Employee Full Name</th>
	<th style="width:100px;">Permission Date</th><th style="width:100px;">Start Time</th><th style="width:100px;">End Time</th><th>Type</th><th>Requested On</th>
	<th style="width:100px;">Status</th>
</tr>
