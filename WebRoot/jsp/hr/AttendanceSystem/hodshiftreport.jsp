...
return false;
 ...
 var a = new Array;
  a[0] = 1;
  a[1] = 4;
var x=window.showModalDialog("hrApprove.do?method=hodshiftreportexe&loc="+loc+"&month="+month+"&year="+year,"dialogwidth=800;dialogheight=600; center:yes;toolbar=no");
...
<body>
	...
	<html:form action="hrApprove" enctype="multipart/form-data">
		...
		<tr>
		<th colspan="5">HOD Shift Report</th>
		</tr>
		<%-- <tr>
