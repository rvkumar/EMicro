...
<th><font color="blue"><big><strong>
 MICRO LABS LIMITED</strong></big><br/>ROLE WISE AUTHORIZATION MATRIX</font></th>
</td>
</tr>
</table>
...
<tr> <td ><center>
<img  src="images/logo.png" width='50' height='60'></center>
</td><th colspan="41"><font color="blue"><big><strong>MICRO LABS LIMITED ,<bean:write name="hrApprovalForm" property="locationId"/>&nbsp;<bean:write name="hrApprovalForm" property="lock_id"/><br/>Daily Manpower Department wise and Sub-department wise as on date  : <bean:write property="fromDate" name="hrApprovalForm"></bean:write></font><%-- &nbsp;To&nbsp;<bean:write property="toDate" name="hrApprovalForm"></bean:write> --%>
</th></tr>
<tr>
<th rowspan="2"><center>Sl.No</center></th ><%-- <th rowspan="2"><center>Location</center></th> --%><th rowspan="2"><center>Department</center></th><th colspan="5"><center>Staff</center></th><th colspan="5"><center>Technical Staff</center></th><th colspan="5"><center>Staff Apprentice</center></th><th colspan="4"><center>Total STAFF,TECHNICAL STAFF,STAFF APPRENTICE</center></th><th rowspan="2"><center>Contract On Roll </center></th >
...
<tr>
<%-- <td style="background-color: #A9A9A9 ;color: black" colspan="41"><center><bean:write name="a" property="department" /></center></td> --%>
</tr>
<tr>
...
<td style="background-color: #A9A9A9 ;color: black">${a.skilledabsent+a.unskilledabsent+a.semiskilledabsent+a.securityabsent+a.projectsabsent}</td>
...
<td>${a.skilledabsent+a.unskilledabsent+a.semiskilledabsent+a.securityabsent+a.projectsabsent}</td>
...
<td style="background-color:#483D8B ;color: white">${hrApprovalForm.grnskilledabsent+hrApprovalForm.grnunskilledabsent+hrApprovalForm.grnsemiskilledabsent+hrApprovalForm.grnsecurityabsent+hrApprovalForm.grnprojectsabsent}</td>
...
<tr><th colspan="42"><center><big><b>MICRO LABS LIMITED ,<bean:write name="hrApprovalForm" property="locationId"/><br/>Manpower details from : <bean:write property="fromDate" name="hrApprovalForm"></bean:write>&nbsp;To&nbsp;<bean:write property="toDate" name="hrApprovalForm"></bean:write>
</th></tr>
<tr>
...
<%-- <th rowspan="1"><center>CKP - SKILLED</center></th  >
<th rowspan="1"><center>CKP - UNSKILLED</center></th  >
<th rowspan="1"><center>CKP - SEMISKILLED</center></th  >
<th rowspan="1"><center>SECURITY</center></th  >
<th rowspan="1"><center>Projects</center></th  > --%>
...
<th rowspan="1" colspan="5"><center>Projects</center></th  >
<th rowspan="2"><center>Total Contract Present</center></th ><th rowspan="2"><center>Total Contract Salary</center></th><th colspan="4"><center>House Keeping</center></th><th rowspan="2"><center>Total  Present</center></th ><th rowspan="2"><center>Total  Salary</center></th><th colspan="4"><center>STAFF,TECHNICAL STAFF,STAFF APPRENTICE</center></th>
</tr>
<tr>
<th><center>Approved Strength</center></th><th><center>ON Roll</center></th><th><center>Present</center></th><th><center>Absent</center></th><th><center>Salary</center></th>
<th><center>Approved Strength</center></th><th><center>ON Roll</center></th><th><center>Present</center></th><th><center>Absent</center></th><th><center>Salary</center></th>
...
<table border="0" >
<tr><td align="right">
Printed By: <bean:write name="hrApprovalForm" property="employeeName"/>
