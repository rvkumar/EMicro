...
var URL="hrApprove.do?method=displaydata&linkname="+link;
...
var URL="hrApprove.do?method=exportdata&linkname="+link;
		document.forms[0].action=URL;
 		document.forms[0].submit();
...
.text_field {
	...
	<body>
		...
		<html:hidden property="explocid" name="hrApprovalForm"/>
		<html:hidden property="expcat"  name="hrApprovalForm"/>

			<table align="center" class="bordered">
				<tr><th><center>Location&nbsp;<html:select property="locationId">
				<html:option value="">--Select--</html:option>
				<html:options property="locationIdList" labelProperty="locationLabelList" name="hrApprovalForm"></html:options>
				</html:select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			Category&nbsp;<html:select property="staffcat">
				<html:option value="">--Select--</html:option>
		...
		<input type="button" class="rounded" value="Export To Excel"
							onclick="exportto('Login')" s style="width: 124px; "/><br/><br/>
          ...
          <input type="button" class="rounded" value="Export To Excel"
							onclick="exportto('Leave')" s style="width: 124px; "/><br/><br/>
		  <table class="bordered">
          ...
          <logic:notEmpty name="alllist">
               ...
               <input type="button" class="rounded" value="Export To Excel"
							onclick="exportto('ALL')" s style="width: 124px; "/><br/><br/>
		  <table class="bordered">
		  ...
		  <tr><td>${a.employeeNo}</td><td>${a.employeeName}</td><td>${a.department}</td><td>${a.designation}</td><td>${a.perstatus}</td><td>${a.addstatus}</td><td>${a.famstatus}</td><td>${a.edustatus}</td><td>${a.expstatus}</td><td>${a.lanstatus}</td></tr>
            ...
            <logic:notEmpty name="perlist">
               <input type="button" class="rounded" value="Export To Excel"
							onclick="exportto('Personal Information')" s style="width: 124px; "/><br/><br/>
		  <table class="bordered">
		  ...
		  <tr><td>${a.employeeNo}</td><td>${a.employeeName}</td><td>${a.department}</td><td>${a.designation}</td><td>${a.status}</td></tr>
           ...
           <logic:notEmpty name="addrlist">
              <input type="button" class="rounded" value="Export To Excel"
							onclick="exportto('Address')" s style="width: 124px; "/><br/><br/>
		  <table class="bordered">
          ...
          <logic:notEmpty name="familist">
             <input type="button" class="rounded" value="Export To Excel"
							onclick="exportto('Family')" s style="width: 124px; "/><br/><br/>
		  <table class="bordered">
		  ...
		  <tr><td>${a.employeeNo}</td><td>${a.employeeName}</td><td>${a.department}</td><td>${a.designation}</td><td>${a.status}</td></tr>
            ...
            <logic:notEmpty name="edulist">
               <input type="button" class="rounded" value="Export To Excel"
							onclick="exportto('Education')" s style="width: 124px; "/><br/><br/>
		  <table class="bordered">
		  ...
		  <tr><td>${a.employeeNo}</td><td>${a.employeeName}</td><td>${a.department}</td><td>${a.designation}</td><td>${a.status}</td></tr>
            ...
            <logic:notEmpty name="explist">
               <input type="button" class="rounded" value="Export To Excel"
							onclick="exportto('Experience')" s style="width: 124px; "/><br/><br/>
		  <table class="bordered">
          ...
          <logic:notEmpty name="langlist">
             <input type="button" class="rounded" value="Export To Excel"
							onclick="exportto('Language')" s style="width: 124px; "/><br/><br/>
		  <table class="bordered">
