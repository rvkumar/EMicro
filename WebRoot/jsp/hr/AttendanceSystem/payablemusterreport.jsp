...
document.forms[0].action="hrApprove.do?method=exportpayablemusterReportSearch";
document.forms[0].submit();
...
<tr>
<th colspan="5">Muster Details</th>
</tr>
...
<tr><th colspan="5">Attendance Locations</th></tr>
<tr><td colspan="5"><big>${hrApprovalForm.locationId }</big></td></tr>
...
<html:select  property="frommonth" name="hrApprovalForm" styleClass="testselect1">
...
<tr>
		<th colspan="5">Attendance type
		</th>
		</tr>
		<tr>
		<td colspan="6">  <input type="radio" name="attntype" id="acb1" value="Calendar Month"  checked="checked"<logic:equal name="hrApprovalForm" property="attntype" value="Calendar Month">checked</logic:equal>>&nbsp;Calendar Month
		
		&nbsp;  <input type="radio" name="attntype" id="acb1" value="Payable Month"  <logic:equal name="hrApprovalForm" property="attntype" value="Payable Month">checked</logic:equal>>&nbsp;Payable Month</td>
		</tr>
...
<tr>
		...
		&nbsp;  <input type="radio" name="summbrkup" id="acb1" value="Detailed"  <logic:equal name="hrApprovalForm" property="summbrkup" value="Detailed">checked</logic:equal>>&nbsp;Detailed</td>
		</tr> -->
