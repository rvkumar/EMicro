...
document.forms[0].submit();
 var a = new Array;
  a[0] = 1;
  a[1] = 4;
var x=window.showModalDialog("hrApprove.do?method=dailyreportexe&loc="+loc+"&date="+k,a, "dialogwidth=800;dialogheight=600; center:yes;toolbar=no");
...
<body>
	...
	<html:form action="hrApprove" enctype="multipart/form-data">
		...
		<tr>
		<th colspan="5">Daily Attendance Detail Report</th>
		</tr>
		<tr>
