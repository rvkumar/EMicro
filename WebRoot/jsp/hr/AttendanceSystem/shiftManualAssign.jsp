...
function previousMonth(){
	...
	function viewshift(currentDate) {
		...
		var x=window.showModalDialog("hrApprove.do?method=UpdateCmpdetails&currentDate="+c+"&plant="+plant+"&emplist="+emplist,null, "dialogWidth=500px;dialogHeight=220px; center:yes");
...
<table class="bordered" >
		<tr>
		<th colspan="5">Day Wise Shift Assign</th>
		</tr>
...
<table align="left"  style="width: 70%;box-shadow: 8px 8px 5px #888888;" >
 <col class="weekend" >
  ...
  <th id="days" ><b><big>Moon</big></b></th>
