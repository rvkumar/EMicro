...
return false;
 ...
 var a = new Array;
  a[0] = 1;
  a[1] = 4;
var x=window.showModalDialog("hrApprove.do?method=monthlysummaryreportexe&loc="+loc+"&month="+month+"&year="+year,"dialogwidth=950;dialogheight=600; center:yes;toolbar=no");
...
<body>
	...
	<html:form action="hrApprove" enctype="multipart/form-data">
		...
		<tr>
		<th colspan="5">Daywise Attendance Summary Report</th>
		</tr>
		<%-- <tr>
 ...
 --%>
	<tr>
		...
		<%-- <html:select  property="month" name="hrApprovalForm" styleClass="testselect1"> --%>
			...
			<%-- <html:option value="">February</html:option> --%>
