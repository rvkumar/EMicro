	...
	if(dep=="")
	   {
	     ...
	     document.forms[0].deptArray.focus();
	 ...
	 document.forms[0].action="hrApprove.do?method=organogrammanpowerreportSearch";
	document.forms[0].submit(); 

	 var a = new Array;
	  a[0] = 1;
	  a[1] = 4;
	var x=window.showModalDialog("hrApprove.do?method=organogrammanpowerreportexe&loc="+loc+"&summbrkup="+view,a, "dialogwidth=800;dialogheight=600; center:yes;toolbar=no");
...
function processexcel()
{
	...
	document.forms[0].action="hrApprove.do?method=exportOrganogrammanpowerreport&loc="+loc+"&summbrkup="+view;
	document.forms[0].submit();
...
<tr>
<th colspan="5">Organogram Man Power Details</th>
</tr>
