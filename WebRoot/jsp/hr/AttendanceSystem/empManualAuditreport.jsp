...
function process()
{
	...
	document.forms[0].action="hrApprove.do?method=empManualAuditreportSearch";
	document.forms[0].submit();
	var x=window.showModalDialog("hrApprove.do?method=empManualAuditreportexe&year="+year+"&loc="+loc,null, "dialogWidth=1000px;dialogHeight=600px; center:yes");
...
document.forms[0].action="hrApprove.do?method=exportempManualAuditreportSearch";
document.forms[0].submit();
...
<tr>
<th colspan="5">Manual Entry Audit Details</th>
</tr>
...
<tr>
	<td>Location</td>
		...
		<html:select  property="locationId" name="hrApprovalForm" styleClass="testselect1" styleId="locationId">
...
<html:select  property="months" name="hrApprovalForm" onchange="console.log($(this).children(':selected').length)" styleClass="testselect1" >
