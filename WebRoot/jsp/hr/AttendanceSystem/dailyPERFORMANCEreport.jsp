...
<body>
	...
	<html:form action="hrApprove" enctype="multipart/form-data">
		...
		<tr>
		<td colspan="6">  	<html:select  property="summbrkup" name="hrApprovalForm" onchange="console.log($(this).children(':selected').length)" styleClass="testselect1" >

<html:option value="All">All</html:option>
<html:option value="Arrival">Arrival</html:option>
