...
function previousMonth(){
	...
	function test(currentDate) {
	    ...
	    var pernr=document.forms[0].frompernr.value;
		...
		var x=window.showModalDialog("hrApprove.do?method=UpdateEMPCmpdetails&currentDate="+c+"&plant="+plant+"&pernr="+pernr,null, "dialogWidth=650px;dialogHeight=420px; center:yes");
...
var hYear=document.forms[0].calYear.value;
	var hMonth=document.forms[0].monthFrom.value;
       if(document.forms[0].frompernr.value==""){
			alert("Please Enter Employee No.");
			document.forms[0].frompernr.focus();
			return false;
		}
	  if(hYear=="")
   	{
	...
	var url="hrApprove.do?method=WeekoffAssignSearch&hYear="+hYear+"&hMonth="+hMonth;
		document.forms[0].action=url;
		document.forms[0].submit();
...
<tr>
		<th colspan="5">Week Off  Assign</th>
		</tr>
					<tr>
		...
		<tr>
		<td>Employee no.<font color="red">*</font></td>
<td colspan="3">
		...
		<td>Month </td>
		<td>
		<html:select  property="monthFrom" name="hrApprovalForm" onchange="console.log($(this).children(':selected').length)" styleClass="testselect1">
...
&nbsp;&nbsp;
	Calender Year
&nbsp;
	<html:text property="calYear" name="hrApprovalForm" style="width: 96px; " ></html:text> &nbsp; &nbsp; &nbsp;
	</td>
...
<div class="text" style="width: 80%; " align="center" >
<img src="images/suday_image.png"/>&nbsp;Week Off(WO)&nbsp;&nbsp;
<img src="images/secon_sat.png"/>&nbsp;Second Sat(SS)&nbsp;&nbsp;
<img src="images/Company_Holiday_Image.png"/>&nbsp;Company Holiday(PH)&nbsp;&nbsp;
</div>
</div>
