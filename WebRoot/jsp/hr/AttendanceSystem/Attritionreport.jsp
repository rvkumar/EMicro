 ...
 */
	...
	document.forms[0].action="hrApprove.do?method=attritionreportSearch";
	document.forms[0].submit();

	 var a = new Array;
	  a[0] = 1;
	  a[1] = 4;
	var x=window.showModalDialog("hrApprove.do?method=attritionreportEXE&loc="+loc+"&month="+month+"&year="+year+"&summbrkup="+summbrkup,a, "dialogwidth=800;dialogheight=600; center:yes;toolbar=no");
...
/* function processexcel()
{
	...
	document.forms[0].action="hrApprove.do?method=exportAttritionreport&loc="+loc+"&month="+month+"&year="+year+"&summbrkup="+summbrkup;
	document.forms[0].submit();
...
<tr>
<th colspan="5">Addition and Attrition Details</th>
</tr>
