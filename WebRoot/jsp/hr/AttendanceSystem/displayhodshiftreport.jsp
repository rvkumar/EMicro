...
<tr><th><center><big><b>MICRO LABS LIMITED,<bean:write name="hrApprovalForm" property="locationId"/><br/>HOD Updated Shift Report for the Month :  <bean:write name="hrApprovalForm" property="month"/></b></big></center>	
...
<div class="row form-group">
				  ...
				  <%int i=0;%>
				    <table class="bordered" >
                     ...
                     <tr>   <th colspan="9"><center>HOD Updated Employees Shift </center></th></tr>
                  <tr>
                ...
                <tr>               
                    ...
                    <td> <bean:write name="abc1" property="approver"/></td>
                    <td> <bean:write name="abc1" property="approveDate"/></td>
                    <td> <bean:write name="abc1" property="approverStatus"/></td>
