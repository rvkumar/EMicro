...
function process()
{
	...
	var shift=document.forms[0].shiftArray.value;
 ...
 */
	...
	document.forms[0].action="hrApprove.do?method=DaywisemanpowerreportSearch&loc="+loc+"";
	document.forms[0].submit();

	 var a = new Array;
	  a[0] = 1;
	  a[1] = 4;
	var x=window.showModalDialog("hrApprove.do?method=Daywisemanpowerreportexe&loc="+loc+"&shift="+shift+"&from="+startDate,a, "dialogwidth=800;dialogheight=600; center:yes;toolbar=no");
...
function processexcel()
{
	...
	document.forms[0].action="hrApprove.do?method=exportDaywisemanpowerreport&shift="+shift+" ";
	document.forms[0].submit();
...
document.forms[0].action="hrApprove.do?method=Daywisemanpowerreport&loc="+loc;
document.forms[0].submit();
...
<tr>
<th colspan="5">Daywise Man Power Details</th>
</tr>
...
<html:select  property="locationId" name="hrApprovalForm" onchange="console.log($(this).children(':selected').length),shiftfilter()" styleClass="testselect1" >
...
<td colspan="3">
<html:select  property="shiftArray" name="hrApprovalForm" styleId="shift" multiple="true" onchange="console.log($(this).children(':selected').length)" styleClass="testSelAll">
			<%-- <html:option value="">--ALL--</html:option> --%>
