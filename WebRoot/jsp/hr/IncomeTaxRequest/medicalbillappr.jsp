...
<td>${a.billno }</td>
<td>${a.billdesc }</td><td>${a.billdate }</td><td style="text-align:right;">${a.billamount }</td><td style="text-align:right;">
	<html:hidden property="ltaID" value="${a.id }"/>
	<html:text property="billamountapproved" value="${a.billamountapproved }" onkeypress="return isNumber(event)" style="text-align:right;"/></td><td colspan="9">${a.remarks }</td>
</tr>
</logic:iterate>
