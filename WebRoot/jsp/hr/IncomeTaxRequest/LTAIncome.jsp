...
<tr><th>Leave Type</th><th>Start Date</th><th>Duration</th><th>End Date</th><th>Duration</th><th>No of Days<th>LTA Amount<br/> Applied For</th><th>LTA Amount Approved</th></tr>
...
<td>${abc.travelStartDate }</td>
	...
	<html:text property="ltaAmtApproved" value="${abc.ltaAmtAprvdFor }" onkeypress="return isNumber(event)" style="text-align:right;"/></td>
</tr>
</logic:iterate>
