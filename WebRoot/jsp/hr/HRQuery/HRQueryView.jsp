...
document.forms[0].action="paysliprequest.do?method=pendingRecords";
	document.forms[0].submit();
}
...
function saveAsset(){
	...
	var url="paysliprequest.do?method=statusChangeHRQuery";
...
<html:button property="method" value="Respond" onclick="saveAsset()" styleClass="rounded"/>&nbsp;<html:button property="method" value="Close" styleClass="rounded" onclick="closeasset()"/>
</center></td>
