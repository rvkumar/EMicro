...
<table class="bordered " width="130%">
 <html:hidden property="assetType" name="hrForm"/>
  <html:hidden property="pERNR" name="hrForm"/>
    <html:hidden property="id" name="hrForm"/>
      <html:hidden property="created_by" name="hrForm"/>
    <html:hidden property="created_Date" name="hrForm"/>
<tr>
<th colspan="4"><center>Asset Updation Form</center></th>
</tr>
<tr><th colspan="4"><big>User Details</big></th></tr>
<tr><td><b>Name:</b></td><td> <bean:write name="hrForm" property="empname" /></td>

<td><b>Employee No:</b></td><td><bean:write name="hrForm" property="pERNR" /></td></tr>
<tr>
<td><b>Department:</b></td><td><bean:write name="hrForm" property="empdep" /></td>
<td><b>Designation:</b></td><td><bean:write name="hrForm" property="empdesg" /></td></tr>
<tr>
<td><b>Location:</b></td><td><bean:write name="hrForm" property="emploc" /></td>
<td><b>Ext No:</b></td><td><bean:write name="hrForm" property="empext" /></td></tr>
<tr><th colspan="4"><big>Asset Details</big></th></tr>
<tr><td>Asset Type</td><td colspan="3"><big><b>${hrForm.assetType}</b></big></td></tr>
<tr>
<td>Asset Description</td><td colspan="3"><html:textarea property="assetDesc" cols="40" rows="5"/></td>
</tr>
<logic:notEqual value="Data Card" property="assetType" name="hrForm">
...
<tr><td>Previous User</td><td><html:text property="prev_user" onkeyup="searchEmployee('prev_user')" styleId="prev_user"></html:text>
	...
	<td>Name</td> <td><html:text property="prev_user_name"  styleId="empname1" disabled="true" name="hrForm"></html:text></td></tr>
       <tr><td>Department</td>
       <td><html:text property="prev_user_dep"  styleId="dept1" disabled="true" name="hrForm" ></html:text></td>
       <td>Designation</td>
       <td><html:text property="prev_user_des"  styleId="desg1" disabled="true" name="hrForm"></html:text></td>
	</tr>
</logic:notEqual>
<logic:equal value="Data Card" property="assetType" name="hrForm">
...
<tr><td colspan="4"><center><logic:notEmpty name="save">
<html:button property="method" value="Add Asset" onclick="saveAsset()" styleClass="rounded"/>&nbsp;<html:button property="method" value="Close" styleClass="rounded" onclick="closeasset()"/>
</logic:notEmpty>
<logic:notEmpty name="update">
<html:button property="method" value="Update Asset" onclick="updateAsset()" styleClass="rounded"/>&nbsp;<html:button property="method" value="Close" styleClass="rounded" onclick="closeasset()"/>
</logic:notEmpty></center></td></tr>
	</table>
