...
function checkAll()
	...
	function modifyGroup(){
				document.forms[0].action="userGroup.do?method=modifyGroup";
				document.forms[0].submit();
    }
...
if(checkBox.checked==true)
	checked=true;
		...
		if(checked==true){
			 document.forms[0].action="userGroup.do?method=addSubGroup";
			document.forms[0].submit();
		}
		else
	...
	function modifySubGroup(){
	        document.forms[0].action="userGroup.do?method=modifySubGroup";
			document.forms[0].submit();
	}
			...
			<table border="1" align="center" width="30%" id="mytable" >
						...
						<tr>
							<td colspan="2" align="center" class="lft style1">
								<html:select name="userGroupForm" property="moduleName" onchange="reFresh('module1');">
						...
						<tr><td colspan=2 bgcolor="#51B0F8"><div align=center>
						<b><font color="white">
						<center>Select Sub Modules</center></font></b></div></td></tr>
						...
						<logic:notEmpty name="modifyGroupButton">
						<tr><td colspan=2 bgcolor="white"><div align=center>
						
						<html:button property="method" value="Modify Group" styleClass="rudraButtonCSS" onclick="modifyGroup();">
						</html:button> 
						</div></td></tr>
						</logic:notEmpty>
					<logic:notEmpty name="addGroupButton">
						...
						<html:button property="method" value="Add Group" styleClass="rudraButtonCSS" onclick="addGroup();">
						</html:button> 
						</div></td></tr>
						
						</logic:notEmpty>
					<logic:notEmpty name="modifySubGroup">
						<tr><td colspan=2 bgcolor="white"><div align=center>
						
						<html:button property="method" value="Modify Sub Group" styleClass="rudraButtonCSS" onclick="modifySubGroup();">
						</html:button> 
						</div></td></tr>
						
					</logic:notEmpty>
				    <logic:notEmpty name="addSubGroup">
						<tr><td colspan=2 bgcolor="white"><div align=center>
						<html:button property="method" value="Add Sub Group" styleClass="rudraButtonCSS"  onclick="addSubGroup();">
						</html:button> 
						</div></td></tr>
						...
						<tr>
						<td  bgcolor="#51B0F8"><font color="white"><center>Select Links</center></font></td>
						<td  bgcolor="#51B0F8">
						<input class="checkbox" type="checkbox" name="checkProp" onclick="checkAll()"/></td>
						</tr>
						<input type="hidden" name="selectedMainModulesArr" value="Main"/>
