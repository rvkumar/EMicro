...
var URL="vcAppr.do?method=newApprover";
...
var URL="vcAppr.do?method=editApprover&loc="+location+"&floor="+floor+"&roomName="+roomname;
		document.forms[0].action=URL;
 		document.forms[0].submit();
} 
...
if (r == true) {
 var URL="vcAppr.do?method=deleteApprs&loc="+location+"&floor="+floor+"&roomName="+roomname;
		document.forms[0].action=URL;
 		document.forms[0].submit();
} else {
 return false;
...
function manageconf(){
	...
	document.forms[0].action="vcAppr.do?method=manageConfroom"
	document.forms[0].submit();
}
...
<html:button property="method" value=" Manage VC Room " styleClass="rounded" onclick="manageconf()" />&nbsp;&nbsp;&nbsp;
