...
<html:form action="authentication" enctype="multipart/form-data">
	...
	<tr><td colspan="3"><header id="header"><h2>Modify Approvers </h2> </header></td></tr>
	<tr>
	...
	<td><html:select  property="requestType" onchange="getInfo()" tabindex="1" >
					...
					<INPUT type="button" value="Add Row" class="sudmit_btn" style="width:75px; height:20px;" onclick="addRow('dataTable')"/>

	<INPUT type="button" value="Delete Row" class="sudmit_btn" style="width:75px; height:20px;" onclick="deleteRow('dataTable')"/>
		</td>
...
<logic:iterate id="abc" name="approverList">
	...
	<TR>
			<TD><INPUT type="checkbox" name="chk" value="" style="width: 20px;"/></TD>
	...
	<TABLE id="dataTable" width="250px"  align="center">
	
		<TR>
			<TD><INPUT type="checkbox" name="chk" style="width: 20px;"/></TD>
			<TD><html:text property="approverID" value="Employee ID" styleId="myEl" onfocus="ClearEMPID (this)" onblur="SetEMPID (this)"/></TD>
			<TD><html:text property="designation" value="Designation" styleId="design" onfocus="ClearDesignation (this)" onblur="SetDesignation (this)"/></TD>
			<TD><html:text property="emailID" value="Email ID" styleId="email" onfocus="ClearEmail (this)" onblur="SetEmail (this)"/></TD>
		</TR>
	...
	<tr>
		<td align="right" >
		<html:button property="method" value="Modify"  styleClass="sudmit_btn" style="width:75px; height:30px;" onclick="modifyDetails()"></html:button>
		<html:button property="method" value="Delete"  styleClass="sudmit_btn" style="width:75px; height:30px;" onclick="deleteDetails()"></html:button>
