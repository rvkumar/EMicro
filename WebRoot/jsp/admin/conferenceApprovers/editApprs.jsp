...
function onModify()
{
	document.forms[0].action="conferenceAppr.do?method=modifyApprs";
 		document.forms[0].submit();
}
...
<td><bean:write name="conferenceApprForm" property="locationname" />
<html:hidden property="locationId" />
<html:hidden property="locationname" />
</td>
<th>Floor<font color="red">*</font></th>

<td><bean:write name="conferenceApprForm" property="floor" />
<html:hidden property="floor" />

</td>
<th>Conf.Room<font color="red">*</font></th>
<td><bean:write name="conferenceApprForm" property="roomName" />
