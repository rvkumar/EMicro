...
xmlhttp.open("POST","conferenceAppr.do?method=getFloorList1&locID="+locId,true);
xmlhttp.send();
}
...
xmlhttp.open("POST","conferenceAppr.do?method=getFloorList1&locID="+dt,true);
xmlhttp.send();
}
   ...
   function adddata(status)
{
   ...
   function onSave(){
	   ...
	   var URL="conferenceAppr.do?method=saveFloor&saveType=Floor";
		document.forms[0].action=URL;
		document.forms[0].submit();
	   }
	   if(document.forms[0].addroom.checked==true){
		   var URL="conferenceAppr.do?method=saveFloor&saveType=Room";
			document.forms[0].action=URL;
			document.forms[0].submit();
		   }
   ...
   function goBack(){
	   var URL="conferenceAppr.do?method=manageConfroom";
		document.forms[0].action=URL;
		document.forms[0].submit();
   }
   ...
   function onModify(){
	   var URL="conferenceAppr.do?method=updateRoomDetails";
		document.forms[0].action=URL;
		document.forms[0].submit();
   }
...
<td><html:select name="conferenceApprForm" property="locationId" onchange="getFloor(this.value)">
		<html:option value="">--Select--</html:option>
		<html:options name="conferenceApprForm" property="locationIdList" labelProperty="locationLabelList"/>
	</html:select>
</td>
...
<div id="subcategoryID" align="left">
	<html:select property="floor" name="conferenceApprForm">
<html:option value="">--Select--</html:option>
...
<th >Conf.Room</th>
<td >
<html:text name="conferenceApprForm" property="roomName" />
...
<tr>
<th>Location<font color="red">*</font></th>
<td><html:select name="conferenceApprForm" property="locationId1" onchange="getFloor(this.value)">
		<html:option value="">--Select--</html:option>
		<html:options name="conferenceApprForm" property="locationIdList" labelProperty="locationLabelList"/>
	</html:select>
</td>
...
<td >
	...
	<html:text name="conferenceApprForm" property="floor1" />
...
setReqFloor('<bean:write name="conferenceApprForm" property="floor"/>');
</script>
