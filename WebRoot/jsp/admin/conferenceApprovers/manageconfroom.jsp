...
function newfloorroom()
{
	...
	document.forms[0].action="conferenceAppr.do?method=addnewconference";
...
function editRoom(loct,floor,room){
	...
	document.forms[0].action="conferenceAppr.do?method=editRoomDetails&loc="+loct+"&Floor="+floor+"&room="+room+"";
 	document.forms[0].submit();
}
