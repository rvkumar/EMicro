...
var URL="conferenceAppr.do?method=addApprovers&floor="+floor+"&roomName="+roomName;
...
var URL="conferenceAppr.do?method=modifyApprovers";
		document.forms[0].action=URL;
 		document.forms[0].submit();
...
document.forms[0].locationId.focus();
    ...
    xmlhttp.onreadystatechange=function(){
     ...
     xmlhttp.open("POST","conferenceAppr.do?method=searchForApprovers&sId=New&searchText="+toadd+"&reqFieldName="+reqFieldName+"&loc="+location,true);
    xmlhttp.send();
}
...
function goBack()
{
	document.forms[0].action="conferenceAppr.do?method=approversList";
 		document.forms[0].submit();
}
...
<html:select name="conferenceApprForm" property="floor" onchange="getRoomList(this.value)">
		<html:option value="">--Select--</html:option>
...
<html:select name="conferenceApprForm" property="roomName">
		<html:option value="">--Select--</html:option>
...
<tr>
	...
	<bean:write property="approver1" name="conferenceApprForm" /></html:text>
...
<tr>
	...
	<bean:write property="approver2" name="conferenceApprForm" /></html:text>
...
<tr>
	...
	<bean:write property="approver3" name="conferenceApprForm" /></html:text>
