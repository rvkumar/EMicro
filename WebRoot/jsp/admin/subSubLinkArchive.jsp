...
function onSubmit(){
		...
		var url="subsubLinkArchive.do?method=saveArchiveData";
	...
	function displayFields(){
		...
		var url="subsubLinkArchive.do?method=displaySubLinksArchiveData";
		document.forms[0].action=url;
		document.forms[0].submit();
	}
	...
	function displaySublinks(){
		...
		var url="subsubLinkArchive.do?method=displaySublinks";
		document.forms[0].action=url;
		document.forms[0].submit();
	}
	...
	function displaySubSubLinks(){
		...
		var url="subsubLinkArchive.do?method=displaySubSublinks";
		document.forms[0].action=url;
		document.forms[0].submit();
	}
	...
	function displaySublinksContent(){
		...
		var url="subsubLinkArchive.do?method=displaySublinksContent";
		document.forms[0].action=url;
		document.forms[0].submit();
	}
	...
	function onUpload(){	   
			...
			var url="subsubLinkArchive.do?method=uploadFile";
			document.forms[0].action=url;
			document.forms[0].submit();	
}
...
function onUploadVideo(){
	...
	var url="subsubLinkArchive.do?method=uploadVideo";
	document.forms[0].action=url;
	document.forms[0].submit();
	}
...
function deleteFiles(){
	...
	var url="subsubLinkArchive.do?method=deleteUploadedMainFile";
	document.forms[0].action=url;
	document.forms[0].submit();
	}	
	function deleteVideos(){
	
	var url="subsubLinkArchive.do?method=deleteUploadedVideo";
	document.forms[0].action=url;
	document.forms[0].submit();
	}
			...
			%>
			 ...
			 <% 
  			...
  			%>
     			...
     			<div align="center">
						<logic:present name="subsubLinkArchiveForm" property="message">
						<font color="red">
							<bean:write name="subsubLinkArchiveForm" property="message" />
						</font>
					</logic:present>
					</div>
<html:form action="/subsubLinkArchive.do" enctype="multipart/form-data">
<input type="hidden" name="MenuIcon2" value="<%=request.getAttribute("MenuIcon") %>"/>
			<FCK:editor instanceName="EditorDefault" width="900">
			<jsp:attribute name="value">
			 <logic:present name="subsubLinkArchiveForm" property="contentDescriptionAdmin">
                      <bean:define id="content" name="subsubLinkArchiveForm"
...
<tr>
<th align="center" valign="middle" class="title" colspan="2">Modify Sub Links Archive </th>
</tr>
...
<tr>
								...
								<td align="left">
									<html:select property="linkName" onchange="displaySublinks()" styleClass="text_field">
										...
										<html:options property="linkValueList"
											labelProperty="linkValueList" name="subsubLinkArchiveForm" />
									</html:select>
								</td>
							</tr>
							...
							<logic:notEmpty name="displaySublinkField">
								...
								<th class="specalt" scope="row">
									...
									<html:select property="subLinkName"  onchange="displaySubSubLinks()" styleClass="text_field">
										<html:option value="">--SELECT--</html:option>
										<html:options property="sublinkValueList"
											labelProperty="sublinkValueList" name="subsubLinkArchiveForm" />
									</html:select>
								</td>
								...
								<th class="specalt" scope="row">
									...
									<html:select property="subSubLinkName" styleClass="text_field">
										...
										<html:options property="subsublinkValueList"
											labelProperty="subsublinkValueList" name="subsubLinkArchiveForm" />
									</html:select>
								</td>
							...
							<tr>
								<td>
									...
									<html:file name="subsubLinkArchiveForm" property="fileNames"/>
								</td>
</tr>
<tr>
							...
							<tr>
								<td>
									...
									<html:file name="subsubLinkArchiveForm" property="videoFileNames" />
								</td>
</tr>
<tr>
								<td align="center" colspan="2">
