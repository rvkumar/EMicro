...
<tr>
<td><b>Email Id To Be Deleted:&nbsp;<font color="red" ></font></b></td><td colspan="3"><bean:write name="helpdeskReportForm" property="emailidDelete"/></td>
</tr>
<tr><td><b>Emails To Be Forwarded To ID:</td><td colspan="3"><bean:write name="helpdeskReportForm" property="forward_MailID"/></td></tr>
<tr>

<td><b>Is He HOD:&nbsp;</b></td><td><bean:write name="helpdeskReportForm" property="isHeHod"/></td>
	
	<td><b>Is This Common ID:&nbsp;</b></td><td><bean:write name="helpdeskReportForm" property="isthisCommonId"/></td>
	
</tr>


<tr><td><b>Delete From :&nbsp;</td><td colspan="4"><bean:write name="helpdeskReportForm" property="deletefrom"/> </td></tr>
<tr><td><b>Required Deleted Mail Database:&nbsp;</td><td>
<bean:write name="helpdeskReportForm" property="deletedDBYes"/>
</td>
<td><b>Path Where To Be Copied</b> </td><td><bean:write name="helpdeskReportForm" property="mailIDPath"/></td>
</tr>
<tr>
	<td><b>Reason:&nbsp;</b></td>
<td colspan="3"><bean:write name="helpdeskReportForm" property="reason"/>	</td>
</tr>
