...
<td><bean:write name="helpdeskReportForm" property="assetcategory"/></td>


<td>Required By Date</td>
<td><bean:write name="helpdeskReportForm" property="reqbydate"/></td>
</tr>

<tr>
<td>Suggested Model If Any:</td>
<td colspan="3"><bean:write name="helpdeskReportForm" property="suggestmodelname"/></td>
</tr>
...
<td colspan="3"><bean:write name="helpdeskReportForm" property="gxpyes"/>
...
<logic:equal value="Printer" name="helpdeskReportForm" property="assetcategory">
<tr >
<td>Type Of Printer<font color="red">*</font></td>
<td><bean:write name="helpdeskReportForm" property="typeofprinter"/>


</td>

<td>Print Volume Per Month</td>
<td><bean:write name="helpdeskReportForm" property="printvolpermonth"/></td>

</tr>
<tr >
<td>No.Of Users</td>
<td><bean:write name="helpdeskReportForm" property="users"/></td>


<td>Suggested Model No. If Any</td>
<td><bean:write name="helpdeskReportForm" property="suggestmodelno"/></td>
...
<td><bean:write name="helpdeskReportForm" property="apprxvalue"/></td>


<td>LAN Connectivity:<font color="red">*</font></td>
<td><bean:write name="helpdeskReportForm" property="lanyes"/>
...
<td colspan="3"><bean:write name="helpdeskReportForm" property="anysplreq"/>
	</td>
</tr>

<tr>
	<td><b>Purpose:&nbsp;<font color="red">*</font></b></td>
<td colspan="3"><bean:write name="helpdeskReportForm" property="purpose"/>
	</td>
</tr>
