...
<td><b>Existing AD Login Name:&nbsp;<font color="red" >*</font></b></td><td ><bean:write name="helpdeskReportForm" property="adloginname"/></td>
...
<tr>
		...
		<bean:write name="helpdeskReportForm" property="fromlocationId"/>
		 	...
		 	<td>
		<bean:write name="helpdeskReportForm" property="tolocationId"/>
			...
			<tr>
		 	...
		 	<td><bean:write name="helpdeskReportForm" property="fromdepartment"/>
				
      			</td>
      			
      			<td><b>To Department:<font color="red" >*</font></b></td>
		 	<td><bean:write name="helpdeskReportForm" property="todepartment"/>
