...
<td colspan="2" ><bean:write name="helpdeskReportForm" property="requiredfoldername"/></td>
<td>&nbsp;&nbsp;<b>Location:</b>
		 	
		&nbsp;&nbsp;
<bean:write name="helpdeskReportForm" property="fromlocationId"/>
...
<bean:write name="helpdeskReportForm" property="accesstype"/>
</td>
<td><b>Asset Details:</b></td>
<td colspan="4">
<bean:write name="helpdeskReportForm" property="assetvalue"/>
...
<tr>
	<td><b>Reason:</b></td>
<td colspan="3">
<bean:write name="helpdeskReportForm" property="reason"/>
...
&nbsp;
	...
	<html:button property="method"  value="Back" onclick="closeData()" styleClass="rounded" style="width: 100px"></html:button>
</td>
</tr>
