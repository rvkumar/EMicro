...
document.getElementById('tableview').scrollIntoView();
  ...
  <body onload="goup()">
<td></td><html:form action="/helpDeskReport.do" enctype="multipart/form-data" >
...
<table class="bordered" id="tableview">
...
<bean:write name="helpdeskReportForm" property="requestStatus"/>
</td>
</tr>
<tr>
...
<html:hidden property="transNo" name="helpdeskReportForm"/>	
<html:hidden property="empType" name="helpdeskReportForm"/>	
<html:hidden property="requestNo" name="helpdeskReportForm" />	
