        ...
        <jsp:include page="/jsp/template/header1.jsp"/>
           <jsp:include page="/jsp/template/subMenu.jsp"/>
                ...
                <div style="padding-left: 10px;width: 70%;" class="content_middle"><!--------CONTENT MIDDLE STARTS -------------------->
					...
					<div align="center">
					<logic:present name="changePasswordForm" property="message">
						<font color="red">
							<bean:write name="changePasswordForm" property="message" />
						</font>
					</logic:present>
				</div>
...
<html:form action="changePassword">
				...
				<table border="1" align="center" width="30%" id="mytable" >
						...
						<font color="white"> Change Password</font></div></td></tr>
						<tr>
							<td>Old Password &nbsp;</td>
							<td><html:password property="oldPassword1"/></td>
						</tr>
						...
						<tr>
							...
							<td><html:password property="confirmNewPassword"/></td>
						</tr>
						
						<tr>
						<td colspan=2>
						<div align=center>
						<html:button property="method" styleClass="rudraButtonCSS" value="Change Password" onclick="changePassword();">
						</html:button>
						 </div></td></tr>
					</table>
